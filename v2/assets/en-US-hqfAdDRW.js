import{_ as o,b as r,e as d,m as p,p as a,q as t,w as l,P as s,Z as c}from"./index-nZQFiiGQ.js";const h={components:{}},j={class:"varlet-site-doc"},i=a("h1",null,"AppBar",-1),g={class:"card"},m={id:"Intro"},u=a("p",null,"Provide navigation function for the page, often used at the top of the page.",-1),_={class:"card"},v={id:"BasicUsage"},f=a("p",null,[s("Set the title of the app bar through the "),a("code",null,"title"),s(" prop.")],-1),b=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`)])],-1),x={class:"card"},S={id:"UseBorderRadius"},y=a("p",null,[s("Turn on rounded border with the "),a("code",null,"round"),s(" prop.")],-1),T=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),B={class:"card"},C={id:"CustomBackgroundColor"},P=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
   ...
   />`)]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),k={class:"card"},I={id:"AddTitleSlot"},A=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),O={class:"card"},N={id:"AddLeftAndRightSlot"},z=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
  `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-app-bar"),s(),a("span",{class:"hljs-attr"},"title"),s("="),a("span",{class:"hljs-string"},'"Title"'),s(">")]),s(`
...
`),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
  `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-app-bar"),s(`
    `),a("span",{class:"hljs-attr"},"round"),s(`
    `),a("span",{class:"hljs-attr"},"image"),s("="),a("span",{class:"hljs-string"},'"https://varletjs.github.io/varlet/tree.jpeg"'),s(`
  ...
  `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-app-bar"),s(">")]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),w=a("h2",null,"API",-1),D={class:"card"},$={id:"Props"},L=c("<table><thead><tr><th>Prop</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>color</code></td><td>Background</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>text-color</code></td><td>Text color</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>title</code></td><td>Title</td><td><em>string</em></td><td>-</td></tr><tr><td><code>title-position</code></td><td>Title location, can be set to <code>left</code>, <code>center</code>, <code>right</code></td><td><em>string</em></td><td><code>left</code></td></tr><tr><td><code>elevation</code></td><td>Elevation level, options <code>true</code> <code>false</code> and level of <code>0-24</code></td><td><em>string | number | boolean</em></td><td><code>true</code></td></tr><tr><td><code>round</code></td><td>Whether to use rounded border</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td><code>image</code></td><td>Background image</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>image-linear-gradient</code></td><td>Background image linear gradient</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>safe-area-top</code></td><td>Whether to enable top safe area adaptation</td><td><em>boolean</em></td><td><code>false</code></td></tr></tbody></table>",1),E={class:"card"},W={id:"Slots"},q=c("<table><thead><tr><th>Name</th><th>Description</th><th>SlotProps</th></tr></thead><tbody><tr><td><code>default</code></td><td>Customize the title content to override the <code>title</code> content</td><td><code>-</code></td></tr><tr><td><code>left</code></td><td>Insert the content to the left of the app bar</td><td><code>-</code></td></tr><tr><td><code>right</code></td><td>Insert the content to the right of the app bar</td><td><code>-</code></td></tr><tr><td><code>content</code></td><td>Insert the content to the extra content of the app bar</td><td><code>-</code></td></tr></tbody></table>",1),H={class:"card"},Z={id:"StyleVariables"},F=c('<p>Here are the CSS variables used by the component. Styles can be customized using <a href="#/en-US/style-provider">StyleProvider</a>.</p><table><thead><tr><th>Variable</th><th>Default</th></tr></thead><tbody><tr><td><code>--app-bar-color</code></td><td><code>var(--color-primary)</code></td></tr><tr><td><code>--app-bar-text-color</code></td><td><code>#fff</code></td></tr><tr><td><code>--app-bar-height</code></td><td><code>54px</code></td></tr><tr><td><code>--app-bar-title-padding</code></td><td><code>0 12px</code></td></tr><tr><td><code>--app-bar-title-font-size</code></td><td><code>var(--font-size-lg)</code></td></tr><tr><td><code>--app-bar-left-gap</code></td><td><code>6px</code></td></tr><tr><td><code>--app-bar-right-gap</code></td><td><code>6px</code></td></tr><tr><td><code>--app-bar-border-radius</code></td><td><code>4px</code></td></tr></tbody></table>',2);function G(J,K,M,Q,X,Y){const n=r("router-link"),e=r("var-site-code-example");return d(),p("div",j,[i,a("div",g,[a("h3",m,[t(n,{to:"#Intro"},{default:l(()=>[s("#")]),_:1}),s("Intro")]),u]),a("div",_,[a("h3",v,[t(n,{to:"#BasicUsage"},{default:l(()=>[s("#")]),_:1}),s("Basic Usage")]),f,t(e,null,{default:l(()=>[b]),_:1})]),a("div",x,[a("h3",S,[t(n,{to:"#UseBorderRadius"},{default:l(()=>[s("#")]),_:1}),s("Use Border Radius")]),y,t(e,null,{default:l(()=>[T]),_:1})]),a("div",B,[a("h3",C,[t(n,{to:"#CustomBackgroundColor"},{default:l(()=>[s("#")]),_:1}),s("Custom Background Color")]),t(e,null,{default:l(()=>[P]),_:1})]),a("div",k,[a("h3",I,[t(n,{to:"#AddTitleSlot"},{default:l(()=>[s("#")]),_:1}),s("Add Title Slot")]),t(e,null,{default:l(()=>[A]),_:1})]),a("div",O,[a("h3",N,[t(n,{to:"#AddLeftAndRightSlot"},{default:l(()=>[s("#")]),_:1}),s("Add Left And Right Slot")]),t(e,null,{default:l(()=>[z]),_:1})]),a("div",U,[a("h3",V,[t(n,{to:"#CustomContent"},{default:l(()=>[s("#")]),_:1}),s("Custom Content")]),t(e,null,{default:l(()=>[R]),_:1})]),w,a("div",D,[a("h3",$,[t(n,{to:"#Props"},{default:l(()=>[s("#")]),_:1}),s("Props")]),L]),a("div",E,[a("h3",W,[t(n,{to:"#Slots"},{default:l(()=>[s("#")]),_:1}),s("Slots")]),q]),a("div",H,[a("h3",Z,[t(n,{to:"#StyleVariables"},{default:l(()=>[s("#")]),_:1}),s("Style Variables")]),F])])}const as=o(h,[["render",G]]);export{as as default};
