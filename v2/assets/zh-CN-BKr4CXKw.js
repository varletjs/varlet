import{_ as h,b as d,e as o,m as p,p as a,q as t,w as l,P as s,Z as e}from"./index-nZQFiiGQ.js";const r={components:{}},j={class:"varlet-site-doc"},i=a("h1",null,"表格",-1),m={class:"card"},g={id:"jie4shao4"},b=a("p",null,"一个极简的表格，当你需要以表格的形式展示一些数据的时候，可能会用的上它。",-1),_={class:"card"},u={id:"ji1ben3shi3yong4"},f=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
