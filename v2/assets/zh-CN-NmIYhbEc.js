import{_ as h,b as d,e as o,m as p,p as a,q as t,w as l,P as s,Z as c}from"./index-nZQFiiGQ.js";const r={components:{}},j={class:"varlet-site-doc"},i=a("h1",null,"菜单",-1),m={class:"card"},g={id:"jie4shao4"},u=a("p",null,"当元素点击时显示一个菜单，通过控制弹出位置和偏移量改变菜单的显示位置。",-1),_={class:"card"},v={id:"ji1ben3shi3yong4"},f=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
