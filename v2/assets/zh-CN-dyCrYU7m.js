import{_ as o,b as c,e as r,m as h,p as t,q as a,w as e,P as s,Z as d}from"./index-aNRZhgSD.js";const i={components:{}},p={class:"varlet-site-doc"},j=t("h1",null,"图片预览",-1),g={class:"card"},m={id:"jie4shao4"},u=t("p",null,"图片放大预览，支持双击倍数放大，支持函数调用和组件调用两种方式。",-1),v=t("h2",null,"函数调用",-1),_={class:"card"},w={id:"ji1ben3shi3yong4"},f=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),b={class:"card"},y={id:"chu3li3hui2tiao2han2shu4"},k=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { ImagePreview } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'@varlet/ui'"),s(`
