import{_ as i,b as c,e as r,m as p,p as s,q as n,w as l,P as a,a1 as o}from"./index-ra5xqBB7.js";const h={components:{}},d={class:"varlet-site-doc"},j=s("h1",null,"Icon",-1),u={class:"card"},m={id:"Intro"},g=s("p",null,[a("Font based icon library, also support web images. Font icons are from "),s("a",{href:"https://materialdesignicons.com/"},"Material Design Icon"),a(".")],-1),_={class:"card"},f={id:"IconSize"},v=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`)])],-1),y={class:"card"},b={id:"IconColor"},k=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`)])],-1),M=s("h4",null,"Project Structure",-1),O=s("p",null,[s("code",null,"svg-icons"),a(" will default to the icon library folder.")],-1),R=s("pre",{class:"hljs"},[s("code",null,`|-- project
   |-- src
     |-- main.ts
   |-- svg-icons
     |-- account-circle.svg
`)],-1),G=s("h4",null,"Import the entry file into the virtual module",-1),J=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// main.ts"),a(`
`),s("span",{class:"hljs-keyword"},"import"),a(),s("span",{class:"hljs-string"},"'virtual-icons'"),a(`
`)])],-1),K=s("h4",null,"Using Icons",-1),Q=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
