import{_ as c,m as p,p as s,q as t,w as a,Q as n,a1 as r,b as l,e as i}from"./index-XHkyQ4jX.js";const h={components:{}},d={class:"varlet-site-doc"},u=s("h1",null,"浏览器适配",-1),m={class:"card"},_={id:"jie4shao4"},j=s("p",null,[n("组件库提供移动端和桌面端适配方案， 移动端使用 "),s("a",{href:"https://github.com/evrone/postcss-px-to-viewport"},"postcss-px-to-viewport"),n(" 方案进行适配， 桌面端使用 "),s("code",null,"@varlet/touch-emulator"),n(" 方案进行适配。")],-1),v={class:"card"},w={id:"yi2dong4duan1shi4pei4"},g=r("<h4>CSS 单位适配</h4><p>组件库设计基于 <code>375px</code> 宽度设计稿，推荐使用 postcss 插件将 <code>px</code> 单位转换成 <code>vmin</code> 单位从而实现移动端适配。 在 <code>webpack/vite</code> 项目根路径下创建 <code>postcss.config.js</code> 并做如下配置之后 <code>375px -&gt; 100vmin</code>。</p>",2),f=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," npm"),n(`
...
`)])],-1);function B(S,U,P,W,q,A){const o=l("router-link"),e=l("var-site-code-example");return i(),p("div",d,[u,s("div",m,[s("h3",_,[t(o,{to:"#jie4shao4"},{default:a(()=>[n("#")]),_:1}),n("介绍")]),j]),s("div",v,[s("h3",w,[t(o,{to:"#yi2dong4duan1shi4pei4"},{default:a(()=>[n("#")]),_:1}),n("移动端适配")]),g,t(e,{"playground-ignore":""},{default:a(()=>[f]),_:1}),t(e,{"playground-ignore":""},{default:a(()=>[x]),_:1}),y,b,t(e,null,{default:a(()=>[k]),_:1}),T,t(e,null,{default:a(()=>[V]),_:1})]),s("div",C,[s("h3",D,[t(o,{to:"#zhuo1mian4duan1shi4pei4"},{default:a(()=>[n("#")]),_:1}),n("桌面端适配")]),N,t(e,{"playground-ignore":""},{default:a(()=>[$]),_:1}),t(e,{"playground-ignore":""},{default:a(()=>[z]),_:1})])])}const L=c(h,[["render",B]]);export{L as default};
