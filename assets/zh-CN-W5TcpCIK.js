import{_ as h,m as o,p as a,q as t,w as l,Q as s,a1 as c,b as d,e as p}from"./index-p72OOaSl.js";const r={components:{}},j={class:"varlet-site-doc"},i=a("h1",null,"菜单",-1),m={class:"card"},g={id:"jie4shao4"},u=a("p",null,"当元素点击时显示一个菜单，通过控制弹出位置和偏移量改变菜单的显示位置。",-1),_={class:"card"},v={id:"ji1ben3shi3yong4"},b=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
  ...
  `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-menu"),s(">")]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),A={class:"card"},I={id:"jin4yong4"},Q=a("p",null,[s("在 "),a("code",null,"disabled"),s(" 状态下，菜单将不再被打开。")],-1),D=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
