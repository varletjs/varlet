import{G as e,L as t,N as n,c as r,d as i,g as a,h as o}from"./runtime-core.esm-bundler-5xw830oL.js";import{t as s}from"./_plugin-vue_export-helper-V-yks4gF.js";var c={components:{}},l={class:`varlet-site-doc`},u={class:`card`},d={id:`Intro`},f={class:`card`},p={id:`InstallZod`},m={class:`card`},h={id:`BasicUsage`},g={class:`card`},_={id:`UseWithTypescript`};function v(s,c,v,y,b,x){let S=t(`router-link`),C=t(`var-site-code-example`);return n(),i(`div`,l,[c[15]||=r(`h1`,null,`Zod Validation`,-1),r(`div`,u,[r(`h3`,d,[a(S,{to:`#Intro`},{default:e(()=>[...c[0]||=[o(`#`,-1)]]),_:1}),c[1]||=o(`Intro`,-1)]),c[2]||=r(`p`,null,[o(`We support form validation based on `),r(`a`,{href:`https://zod.dev/`},`Zod`),o(` in `),r(`code`,null,`3.5.0+`),o(`. `),r(`code`,null,`Zod`),o(` is a very powerful data validation tool and is very friendly to `),r(`code`,null,`Typescript`),o(`.`)],-1)]),r(`div`,f,[r(`h3`,p,[a(S,{to:`#InstallZod`},{default:e(()=>[...c[3]||=[o(`#`,-1)]]),_:1}),c[4]||=o(`Install Zod`,-1)]),c[6]||=r(`p`,null,[o(`In order to control the size of the component library, we do not build-in `),r(`code`,null,`Zod`),o(`, so you need to install it manually.`)],-1),a(C,null,{default:e(()=>[...c[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-meta`},`#`),r(`span`,{class:`bash`},` npm`),o(`
npm i zod -S   
...
pnpm add zod
`)])],-1)]]),_:1})]),r(`div`,m,[r(`h3`,h,[a(S,{to:`#BasicUsage`},{default:e(()=>[...c[7]||=[o(`#`,-1)]]),_:1}),c[8]||=o(`Basic Usage`,-1)]),c[10]||=r(`p`,null,[o(`The `),r(`code`,null,`rules`),o(` property of each form component supports passing in one or more `),r(`code`,null,`Zod Schema`),o(`. The component will use the rules of the `),r(`code`,null,`Schema`),o(` for validation, and when validation fails, the error message defined in it will be used as a user prompt.`)],-1),a(C,null,{default:e(()=>[...c[9]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,g,[r(`h3`,_,[a(S,{to:`#UseWithTypescript`},{default:e(()=>[...c[11]||=[o(`#`,-1)]]),_:1}),c[12]||=o(`Use With Typescript`,-1)]),c[14]||=r(`p`,null,[o(`If you use `),r(`code`,null,`Typescript`),o(`, define a `),r(`code`,null,`Zod Schema`),o(` to get both Typescript types and form rules.`)],-1),a(C,null,{default:e(()=>[...c[13]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(),r(`span`,{class:`hljs-attr`},`lang`),o(`=`),r(`span`,{class:`hljs-string`},`"ts"`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { z } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'zod'`),o(`
