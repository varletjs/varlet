import{b as p,m as i,p as s,q as e,Q as t,w as o,$ as d,e as r,h as m}from"./index-BvpNkg8r.js";const u={components:{}},c={class:"varlet-site-doc"},h={class:"card"},j={id:"Intro"},v={class:"card"},w={id:"MobileAdaptation"},f={class:"card"},b={id:"DesktopAdaptation"};function g(k,n,y,T,x,A){const a=r("router-link"),l=r("var-site-code-example");return m(),i("div",c,[n[23]||(n[23]=s("h1",null,"Browser Adaptation",-1)),s("div",h,[s("h3",j,[e(a,{to:"#Intro"},{default:o(()=>n[0]||(n[0]=[t("#")])),_:1}),n[1]||(n[1]=t("Intro"))]),n[2]||(n[2]=s("p",null,[t("The component library provides mobile and desktop adaptations, scheme "),s("code",null,"varlet-touch-emulator"),t(" is used for mobile terminal adaptation, scheme "),s("code",null,"varlet-touch-emulator"),t(" is used for mobile terminal adaptation.")],-1))]),s("div",v,[s("h3",w,[e(a,{to:"#MobileAdaptation"},{default:o(()=>n[3]||(n[3]=[t("#")])),_:1}),n[4]||(n[4]=t("Mobile Adaptation"))]),n[11]||(n[11]=d('<h4>CSS Unit Adaptation</h4><p>The component library design is based on the <code>375px</code> width design draft. It is recommended to use <a href="https://github.com/evrone/postcss-px-to-viewport">postcss-px-to-viewport</a> to convert <code>px</code> units into <code>vw</code> units to achieve mobile terminal adaptation. Create <code>postcss.config.js</code> under the <code>Webpack/Vite</code> project root path And do the following configuration <code>375px -&gt; 100vw</code>.</p>',2)),e(l,{"playground-ignore":""},{default:o(()=>n[5]||(n[5]=[s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," npm"),t(`
