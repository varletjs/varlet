import{b as o,m as i,p as s,q as l,Q as a,w as t,e as p,h as d}from"./index-CZQCPObA.js";const u={components:{}},j={class:"varlet-site-doc"},h={class:"card"},m={id:"jie4shao4"},c={class:"card"},g={id:"an1zhuang1"},v={class:"card"},y={id:"zhi1chi2zhuo1mian4duan1"},f={class:"card"},b={id:"xuan3ze2she4ji4xi4tong3"},k={class:"card"},x={id:"zai4xian4ti3yan4zu3jian4"};function z(w,n,V,D,A,M){const r=p("router-link"),e=p("var-site-code-example");return d(),i("div",j,[n[22]||(n[22]=s("h1",null,"快速开始",-1)),s("div",h,[s("h3",m,[l(r,{to:"#jie4shao4"},{default:t(()=>n[0]||(n[0]=[a("#")])),_:1}),n[1]||(n[1]=a("介绍"))]),n[2]||(n[2]=s("p",null,"这里为您介绍常见开发模式下接入组件库的最基本方式。",-1))]),s("div",c,[s("h3",g,[l(r,{to:"#an1zhuang1"},{default:t(()=>n[3]||(n[3]=[a("#")])),_:1}),n[4]||(n[4]=a("安装"))]),n[8]||(n[8]=s("h4",null,"CDN",-1)),n[9]||(n[9]=s("p",null,[s("code",null,"varlet.js"),a(" 包含组件库的所有样式和逻辑, 引入即可。")],-1)),l(e,{"playground-ignore":""},{default:t(()=>n[5]||(n[5]=[s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"div"),a(),s("span",{class:"hljs-attr"},"id"),a("="),s("span",{class:"hljs-string"},'"app"'),a(">")]),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"div"),a(">")]),a(`
...
`)])],-1)])),_:1})]),s("div",k,[s("h3",x,[l(r,{to:"#zai4xian4ti3yan4zu3jian4"},{default:t(()=>n[19]||(n[19]=[a("#")])),_:1}),n[20]||(n[20]=a("在线体验组件"))]),n[21]||(n[21]=s("p",null,[a("我们提供了网页版的组件编辑器，方便您对组件库的各个组件进行快速上手、在线编辑、分享给他人或是下载代码包本地运行。 您可以点击网页右上角的 "),s("code",null,"{...}"),a(" 图标或是 "),s("a",{href:"https://varletjs.org/playground"},"这里前往"),a("。")],-1))])])}const C=o(u,[["render",z]]);export{C as default};
