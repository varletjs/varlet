import{_ as c,b as l,e as p,m as r,p as s,q as a,w as t,P as n,a1 as i}from"./index-ra5xqBB7.js";const h={components:{}},d={class:"varlet-site-doc"},u=s("h1",null,"浏览器适配",-1),m={class:"card"},_={id:"jie4shao4"},j=s("p",null,[n("组件库提供移动端和桌面端适配方案， 移动端使用 "),s("code",null,"postcss-px-to-viewport"),n(" 方案进行适配， 桌面端使用 "),s("code",null,"@varlet/touch-emulator"),n(" 方案进行适配。")],-1),v={class:"card"},w={id:"yi2dong4duan1shi4pei4"},g=i("<h4>CSS 单位适配</h4><p>组件库设计基于 <code>375px</code> 宽度设计稿，推荐使用 postcss 插件将 <code>px</code> 单位转换成 <code>vmin</code> 单位从而实现移动端适配。 在 <code>webpack/vite</code> 项目根路径下创建 <code>postcss.config.js</code> 并做如下配置之后 <code>375px -&gt; 100vmin</code>。</p>",2),f=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," npm"),n(`
