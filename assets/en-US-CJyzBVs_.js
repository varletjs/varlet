import{G as e,L as t,N as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-5xw830oL.js";import{t as c}from"./_plugin-vue_export-helper-V-yks4gF.js";var l={components:{}},u={class:`varlet-site-doc`},d={class:`card`},f={id:`Intro`},p={class:`card`},m={id:`BasicUse`},h={class:`card`},g={id:`LoadFail`},_={class:`card`},v={id:`TipText`},y={class:`card`},b={id:`Combine`},x={class:`card`},S={id:`BeCareful`},C={class:`card`},w={id:`Props`},T={class:`card`},E={id:`Methods`},D={class:`card`},O={id:`Events`},k={class:`card`},A={id:`Slots`},j={class:`card`},M={id:`StyleVariables`};function N(c,l,N,P,F,I){let L=t(`router-link`),R=t(`var-site-code-example`);return n(),i(`div`,u,[l[36]||=r(`h1`,null,`List`,-1),r(`div`,d,[r(`h3`,f,[a(L,{to:`#Intro`},{default:e(()=>[...l[0]||=[o(`#`,-1)]]),_:1}),l[1]||=o(`Intro`,-1)]),l[2]||=r(`p`,null,`Unlimited scroll load list, touch bottom load, support manual check position load. Support custom loading state, error state, data loading completed state.`,-1)]),r(`div`,p,[r(`h3`,m,[a(L,{to:`#BasicUse`},{default:e(()=>[...l[3]||=[o(`#`,-1)]]),_:1}),l[4]||=o(`Basic Use`,-1)]),l[6]||=r(`p`,null,[o(`The `),r(`code`,null,`load`),o(` event is emitted when a scroll container is detected scrolling to the bottom, and will be set `),r(`code`,null,`loading`),o(` to `),r(`code`,null,`true`),o(`, you need to manually set `),r(`code`,null,`loading`),o(` to `),r(`code`,null,`false`),o(` at the end of loading, that's the end of the load.`)],-1),a(R,null,{default:e(()=>[...l[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,h,[r(`h3`,g,[a(L,{to:`#LoadFail`},{default:e(()=>[...l[7]||=[o(`#`,-1)]]),_:1}),l[8]||=o(`Load Fail`,-1)]),l[10]||=r(`p`,null,[o(`You can manually set the error status using `),r(`code`,null,`v-model:error`),o(`, an error message is displayed. Clicking on the error message will help you set the `),r(`code`,null,`error`),o(` to `),r(`code`,null,`false`),o(` and trigger the `),r(`code`,null,`load`),o(` event again.`)],-1),a(R,null,{default:e(()=>[...l[9]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-list`),o(`>`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,_,[r(`h3`,v,[a(L,{to:`#TipText`},{default:e(()=>[...l[11]||=[o(`#`,-1)]]),_:1}),l[12]||=o(`Tip Text`,-1)]),a(R,null,{default:e(()=>[...l[13]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-list`),o(`>`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,y,[r(`h3`,b,[a(L,{to:`#Combine`},{default:e(()=>[...l[14]||=[o(`#`,-1)]]),_:1}),l[15]||=o(`Combine`,-1)]),l[17]||=r(`p`,null,[o(`Combined with the `),r(`code`,null,`PullRefresh`),o(` component to implement the function of pull-up loading and pull-down refresh, ensuring the height of the `),r(`code`,null,`PullRefresh`),o(` is not `),r(`code`,null,`0`),o(`.`)],-1),a(R,null,{default:e(()=>[...l[16]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
