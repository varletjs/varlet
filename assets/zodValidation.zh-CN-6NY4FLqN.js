import{G as e,L as t,N as n,c as r,d as i,g as a,h as o}from"./runtime-core.esm-bundler-5xw830oL.js";import{t as s}from"./_plugin-vue_export-helper-V-yks4gF.js";var c={components:{}},l={class:`varlet-site-doc`},u={class:`card`},d={id:`jie4shao4`},f={class:`card`},p={id:`an1zhuang1Zo0d`},m={class:`card`},h={id:`ji1ben3shi3yong4`},g={class:`card`},_={id:`jie2he2Type0scri0ptshi3yong4`};function v(s,c,v,y,b,x){let S=t(`router-link`),C=t(`var-site-code-example`);return n(),i(`div`,l,[c[15]||=r(`h1`,null,`Zod 验证`,-1),r(`div`,u,[r(`h3`,d,[a(S,{to:`#jie4shao4`},{default:e(()=>[...c[0]||=[o(`#`,-1)]]),_:1}),c[1]||=o(`介绍`,-1)]),c[2]||=r(`p`,null,[o(`我们在 `),r(`code`,null,`3.5.0+`),o(` 支持了基于 `),r(`a`,{href:`https://zod.dev/`},`Zod`),o(` 的表单验证方式，`),r(`code`,null,`Zod`),o(` 是一个非常强大的数据验证工具，并且对 `),r(`code`,null,`Typescript`),o(` 十分友好。`)],-1)]),r(`div`,f,[r(`h3`,p,[a(S,{to:`#an1zhuang1Zo0d`},{default:e(()=>[...c[3]||=[o(`#`,-1)]]),_:1}),c[4]||=o(`安装 Zod`,-1)]),c[6]||=r(`p`,null,[o(`为了控制组件库的尺寸，我们不内置 `),r(`code`,null,`Zod`),o(`，所以需要手动安装。`)],-1),a(C,null,{default:e(()=>[...c[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-meta`},`#`),r(`span`,{class:`bash`},` npm`),o(`
npm i zod -S   
...
pnpm add zod
`)])],-1)]]),_:1})]),r(`div`,m,[r(`h3`,h,[a(S,{to:`#ji1ben3shi3yong4`},{default:e(()=>[...c[7]||=[o(`#`,-1)]]),_:1}),c[8]||=o(`基本使用`,-1)]),c[10]||=r(`p`,null,[o(`每个表单组件的 `),r(`code`,null,`rules`),o(` 属性支持传入一个或多个 `),r(`code`,null,`Zod Schema`),o(`。 组件将使用该 `),r(`code`,null,`Schema`),o(` 的规则进行验证，验证失败时将使用其定义的错误信息作为用户提示。`)],-1),a(C,null,{default:e(()=>[...c[9]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,g,[r(`h3`,_,[a(S,{to:`#jie2he2Type0scri0ptshi3yong4`},{default:e(()=>[...c[11]||=[o(`#`,-1)]]),_:1}),c[12]||=o(`结合 Typescript 使用`,-1)]),c[14]||=r(`p`,null,[o(`如果您使用 `),r(`code`,null,`Typescript`),o(`，定义一个 `),r(`code`,null,`Zod Schema`),o(` 可以同时得到 Typescript 类型和表单 rules。`)],-1),a(C,null,{default:e(()=>[...c[13]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(),r(`span`,{class:`hljs-attr`},`lang`),o(`=`),r(`span`,{class:`hljs-string`},`"ts"`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { z } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'zod'`),o(`
