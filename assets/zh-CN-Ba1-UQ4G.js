import{b as r,m as i,p as t,q as a,Q as s,w as l,$ as o,e as c,h as p}from"./index-DA5cNuNL.js";const h={components:{}},j={class:"varlet-site-doc"},m={class:"card"},g={id:"jie4shao4"},u={class:"card"},f={id:"ji1ben3shi3yong4"},b={class:"card"},y={id:"xiu1gai3biao1ti2"},v={class:"card"},k={id:"yin3cang2an4niu3"},w={class:"card"},B={id:"chu3li3yong4hu4xing2wei2"},x={class:"card"},D={id:"yi4bu4guan1bi4"},C={class:"card"},S={id:"ji1ben3shi3yong4"},O={class:"card"},T={id:"yi4bu4guan1bi4"},z={class:"card"},L={id:"zi4ding4yi4cha1cao2"},E={class:"card"},A={id:"shu3xing4"},N={class:"card"},$={id:"shi4jian4"},V={class:"card"},P={id:"fang1fa3"},F={class:"card"},K={id:"DialogOptions"},q={class:"card"},I={id:"cha1cao2"},Q={class:"card"},_={id:"yang4shi4bian4liang4"};function G(H,d,J,M,R,U){const n=c("router-link"),e=c("var-site-code-example");return p(),i("div",j,[d[47]||(d[47]=t("h1",null,"对话框",-1)),t("div",m,[t("h3",g,[a(n,{to:"#jie4shao4"},{default:l(()=>[...d[0]||(d[0]=[s("#",-1)])]),_:1}),d[1]||(d[1]=s("介绍",-1))]),d[2]||(d[2]=t("p",null,[s("弹出一个对话框展示内容并处理用户交互。 "),t("code",null,"Dialog"),s(" 提供了函数式和组件式两种使用方式，两种使用效果和参数并没有本质区别。")],-1))]),d[48]||(d[48]=t("h2",null,"函数调用",-1)),t("div",u,[t("h3",f,[a(n,{to:"#ji1ben3shi3yong4"},{default:l(()=>[...d[3]||(d[3]=[s("#",-1)])]),_:1}),d[4]||(d[4]=s("基本使用",-1))]),a(e,null,{default:l(()=>[...d[5]||(d[5]=[t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1)])]),_:1})]),t("div",b,[t("h3",y,[a(n,{to:"#xiu1gai3biao1ti2"},{default:l(()=>[...d[6]||(d[6]=[s("#",-1)])]),_:1}),d[7]||(d[7]=s("修改标题",-1))]),a(e,null,{default:l(()=>[...d[8]||(d[8]=[t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { Dialog } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'@varlet/ui'"),s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1)])]),_:1})]),t("div",v,[t("h3",k,[a(n,{to:"#yin3cang2an4niu3"},{default:l(()=>[...d[9]||(d[9]=[s("#",-1)])]),_:1}),d[10]||(d[10]=s("隐藏按钮",-1))]),a(e,null,{default:l(()=>[...d[11]||(d[11]=[t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { Dialog } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'@varlet/ui'"),s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1)])]),_:1})]),t("div",w,[t("h3",B,[a(n,{to:"#chu3li3yong4hu4xing2wei2"},{default:l(()=>[...d[12]||(d[12]=[s("#",-1)])]),_:1}),d[13]||(d[13]=s("处理用户行为",-1))]),d[15]||(d[15]=t("p",null,[s("可以通过 "),t("code",null,"Dialog"),s(" 方法的返回值获取用户行为, 返回值是一个 "),t("code",null,"promise"),s("。 包含 "),t("code",null,"confirm(确认)"),s("、"),t("code",null,"cancel(取消)"),s("、"),t("code",null,"close(通过点击遮罩层触发关闭)"),s(" 三种状态。")],-1)),a(e,null,{default:l(()=>[...d[14]||(d[14]=[t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1)])]),_:1})]),t("div",x,[t("h3",D,[a(n,{to:"#yi4bu4guan1bi4"},{default:l(()=>[...d[16]||(d[16]=[s("#",-1)])]),_:1}),d[17]||(d[17]=s("异步关闭",-1))]),d[19]||(d[19]=t("p",null,[t("code",null,"Dialog"),s(" 可以通过 "),t("code",null,"onBeforeClose"),s(" 进行关闭前的拦截，可以从参数中得到用户行为和触发关闭的回调函数。")],-1)),a(e,null,{default:l(()=>[...d[18]||(d[18]=[t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { Dialog, Snackbar } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'@varlet/ui'"),s(`
...
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1)])]),_:1})]),d[49]||(d[49]=t("h2",null,"组件调用",-1)),t("div",C,[t("h3",S,[a(n,{to:"#ji1ben3shi3yong4"},{default:l(()=>[...d[20]||(d[20]=[s("#",-1)])]),_:1}),d[21]||(d[21]=s("基本使用",-1))]),a(e,null,{default:l(()=>[...d[22]||(d[22]=[t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
...
`),t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
  ...
  />`)]),s(`
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1)])]),_:1})]),t("div",O,[t("h3",T,[a(n,{to:"#yi4bu4guan1bi4"},{default:l(()=>[...d[23]||(d[23]=[s("#",-1)])]),_:1}),d[24]||(d[24]=s("异步关闭",-1))]),a(e,null,{default:l(()=>[...d[25]||(d[25]=[t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { ref } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'vue'"),s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { Snackbar } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'@varlet/ui'"),s(`

`),t("span",{class:"hljs-keyword"},"const"),s(" show = ref("),t("span",{class:"hljs-literal"},"false"),s(`)

`),t("span",{class:"hljs-function"},[t("span",{class:"hljs-keyword"},"function"),s(),t("span",{class:"hljs-title"},"onBeforeClose"),s("("),t("span",{class:"hljs-params"},`action, done, { 
  confirmButtonLoading, 
  cancelButtonLoading, 
  confirmButtonDisabled, 
  cancelButtonDisabled 
}`),s(") ")]),s(`{
  `),t("span",{class:"hljs-keyword"},"if"),s(" (action === "),t("span",{class:"hljs-string"},"'confirm'"),s(`) {
    confirmButtonLoading.value = `),t("span",{class:"hljs-literal"},"true"),s(`
    cancelButtonDisabled.value = `),t("span",{class:"hljs-literal"},"true"),s(`
  }

  `),t("span",{class:"hljs-keyword"},"if"),s(" (action === "),t("span",{class:"hljs-string"},"'cancel'"),s(`) {
    cancelButtonLoading.value = `),t("span",{class:"hljs-literal"},"true"),s(`
    confirmButtonDisabled.value = `),t("span",{class:"hljs-literal"},"true"),s(`
  }

  `),t("span",{class:"hljs-built_in"},"setTimeout"),s("("),t("span",{class:"hljs-function"},"() =>"),s(` {
    confirmButtonLoading.value = `),t("span",{class:"hljs-literal"},"false"),s(`
    cancelButtonLoading.value = `),t("span",{class:"hljs-literal"},"false"),s(`
    confirmButtonDisabled.value = `),t("span",{class:"hljs-literal"},"false"),s(`
    cancelButtonDisabled.value = `),t("span",{class:"hljs-literal"},"false"),s(`

    `),t("span",{class:"hljs-keyword"},"if"),s(" (action === "),t("span",{class:"hljs-string"},"'confirm'"),s(`) {
      Snackbar.success(`),t("span",{class:"hljs-string"},"'confirm'"),s(`)
    }

    `),t("span",{class:"hljs-keyword"},"if"),s(" (action === "),t("span",{class:"hljs-string"},"'cancel'"),s(`) {
      Snackbar.error(`),t("span",{class:"hljs-string"},"'cancel'"),s(`)
    }

    `),t("span",{class:"hljs-keyword"},"if"),s(" (action === "),t("span",{class:"hljs-string"},"'close'"),s(`) {
      Snackbar.info(`),t("span",{class:"hljs-string"},"'close'"),s(`)
    }
...
`),t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
  ...
  />`)]),s(`
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1)])]),_:1})]),t("div",z,[t("h3",L,[a(n,{to:"#zi4ding4yi4cha1cao2"},{default:l(()=>[...d[26]||(d[26]=[s("#",-1)])]),_:1}),d[27]||(d[27]=s("自定义插槽",-1))]),a(e,null,{default:l(()=>[...d[28]||(d[28]=[t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { ref } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'vue'"),s(`
