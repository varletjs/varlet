...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),S=s("h2",null,"API",-1),x={class:"card"},T={id:"shu3xing4"},P=p("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>style-vars</code></td><td>CSS 变量</td><td><em>Record&lt;string, string&gt;</em></td><td><code>{}</code></td></tr><tr><td><code>tag</code></td><td>自定义标签名</td><td><em>string</em></td><td><code>div</code></td></tr></tbody></table>",1),N={class:"card"},$={id:"cha1cao2"},C=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"插槽名"),s("th",null,"说明"),s("th",null,"参数")])]),s("tbody",null,[s("tr",null,[s("td",null,[s("code",null,"default")]),s("td",null,"组件内容"),s("td",null,[s("code",null,"-")])])])],-1);function z(B,R,q,A,E,I){const n=c("router-link"),e=c("var-site-code-example");return r(),h("div",i,[j,s("div",u,[s("h3",_,[l(n,{to:"#jie4shao4"},{default:t(()=>[a("#")]),_:1}),a("介绍")]),g]),s("div",m,[s("h3",v,[l(n,{to:"#zu3jian4shi4diao4yong4"},{default:t(()=>[a("#")]),_:1}),a("组件式调用")]),y,l(e,null,{default:t(()=>[k]),_:1})]),s("div",f,[s("h3",b,[l(n,{to:"#han2shu4shi4diao4yong4"},{default:t(()=>[a("#")]),_:1}),a("函数式调用")]),w,l(e,null,{default:t(()=>[V]),_:1})]),S,s("div",x,[s("h3",T,[l(n,{to:"#shu3xing4"},{default:t(()=>[a("#")]),_:1}),a("属性")]),P]),s("div",N,[s("h3",$,[l(n,{to:"#cha1cao2"},{default:t(()=>[a("#")]),_:1}),a("插槽")]),C])])}const F=o(d,[["render",z]]);export{F as default};
