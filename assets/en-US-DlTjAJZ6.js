import{b as c,m as i,p as s,q as n,Q as t,w as a,$ as p,e as o,h as d}from"./index-Cr7vS9Mv.js";const h={components:{}},u={class:"varlet-site-doc"},m={class:"card"},j={id:"Intro"},g={class:"card"},v={id:"ComponentCall"},y={class:"card"},f={id:"FunctionCall"},b={class:"card"},k={id:"Props"},w={class:"card"},C={id:"Slots"};function S(T,l,P,x,V,_){const e=o("router-link"),r=o("var-site-code-example");return d(),i("div",u,[l[16]||(l[16]=s("h1",null,"Style Provider",-1)),s("div",m,[s("h3",j,[n(e,{to:"#Intro"},{default:a(()=>l[0]||(l[0]=[t("#")])),_:1}),l[1]||(l[1]=t("Intro"))]),l[2]||(l[2]=s("p",null,[t("Style variables can be easily mounted through the StyleProvider component. The component provides two calling methods: "),s("code",null,"component calling"),t(" and "),s("code",null,"functional calling"),t(".")],-1))]),s("div",g,[s("h3",v,[n(e,{to:"#ComponentCall"},{default:a(()=>l[3]||(l[3]=[t("#")])),_:1}),l[4]||(l[4]=t("Component Call"))]),l[6]||(l[6]=s("p",null,[t("Component calls can have a scope of custom component styles, Scope contamination is avoided. Note that some elements sent outside the StyleProvider using the "),s("code",null,"teleport"),t(" will not work.")],-1)),n(r,null,{default:a(()=>l[5]||(l[5]=[s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"script"),t(),s("span",{class:"hljs-attr"},"setup"),t(">")]),s("span",{class:"javascript"},[t(`
