...
`)])],-1),D={class:"card"},S={id:"Chooseadesignsystem"},V=s("p",null,"Starting from version 3.x, Varlet supports both Material Design 2 and Material Design 3 design systems.",-1),x=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// Varlet defaults to Material Design 2 light mode"),a(`
...
`)])],-1),M={class:"card"},P={id:"SupportDesktop"},A=s("p",null,[a("Details see "),s("a",{href:"#/en-US/browserAdaptation"},"here"),a(".")],-1),I={class:"card"},T={id:"ComponentsPlayground"},B=s("p",null,[a("We provide a web version of the component editor, which is convenient for you to quickly get started with each component of the component library, edit it online, share it with others, or download the code package to run locally. You can click the "),s("code",null,"{...}"),a(" icon in the upper right corner of the page or "),s("a",{href:"https://varlet.pages.dev/playground"},"go here"),a(".")],-1);function N($,q,L,U,W,E){const e=o("router-link"),l=o("var-site-code-example");return c(),p("div",h,[d,s("div",u,[s("h3",m,[n(e,{to:"#Intro"},{default:t(()=>[a("#")]),_:1}),a("Intro")]),_]),s("div",j,[s("h3",g,[n(e,{to:"#Install"},{default:t(()=>[a("#")]),_:1}),a("Install")]),v,y,n(l,{"playground-ignore":""},{default:t(()=>[f]),_:1}),k,n(l,{"playground-ignore":""},{default:t(()=>[b]),_:1}),n(l,{"playground-ignore":""},{default:t(()=>[w]),_:1})]),s("div",D,[s("h3",S,[n(e,{to:"#Chooseadesignsystem"},{default:t(()=>[a("#")]),_:1}),a("Choose a design system")]),V,n(l,{"playground-ignore":""},{default:t(()=>[x]),_:1}),n(l,{"playground-ignore":""},{default:t(()=>[C]),_:1})]),s("div",M,[s("h3",P,[n(e,{to:"#SupportDesktop"},{default:t(()=>[a("#")]),_:1}),a("Support Desktop")]),A]),s("div",I,[s("h3",T,[n(e,{to:"#ComponentsPlayground"},{default:t(()=>[a("#")]),_:1}),a("Components Playground")]),B])])}const Q=r(i,[["render",N]]);export{Q as default};
