...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),T=s("h2",null,"API",-1),C={class:"card"},P={id:"Props"},V=h("<table><thead><tr><th>Prop</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>style-vars</code></td><td>CSS variables</td><td><em>Record&lt;string, string&gt;</em></td><td><code>{}</code></td></tr><tr><td><code>tag</code></td><td>Tag name</td><td><em>string</em></td><td><code>div</code></td></tr></tbody></table>",1),x={class:"card"},N={id:"Slots"},$=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"Name"),s("th",null,"Description"),s("th",null,"SlotProps")])]),s("tbody",null,[s("tr",null,[s("td",null,[s("code",null,"default")]),s("td",null,"Component content"),s("td",null,[s("code",null,"-")])])])],-1);function I(R,B,D,F,q,A){const n=c("router-link"),e=c("var-site-code-example");return r(),p("div",d,[j,s("div",u,[s("h3",m,[l(n,{to:"#Intro"},{default:t(()=>[a("#")]),_:1}),a("Intro")]),_]),s("div",g,[s("h3",v,[l(n,{to:"#ComponentCall"},{default:t(()=>[a("#")]),_:1}),a("Component Call")]),y,l(e,null,{default:t(()=>[f]),_:1})]),s("div",k,[s("h3",b,[l(n,{to:"#FunctionCall"},{default:t(()=>[a("#")]),_:1}),a("Function Call")]),w,l(e,null,{default:t(()=>[S]),_:1})]),T,s("div",C,[s("h3",P,[l(n,{to:"#Props"},{default:t(()=>[a("#")]),_:1}),a("Props")]),V]),s("div",x,[s("h3",N,[l(n,{to:"#Slots"},{default:t(()=>[a("#")]),_:1}),a("Slots")]),$])])}const U=o(i,[["render",I]]);export{U as default};
