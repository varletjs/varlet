...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1);function k(B,w,C,N,$,V){const e=o("router-link"),l=o("var-site-code-example");return r(),p("div",i,[_,s("div",d,[s("h3",j,[n(e,{to:"#jie4shao4"},{default:t(()=>[a("#")]),_:1}),a("介绍")]),m]),s("div",u,[s("h3",g,[n(e,{to:"#ji1ben3yong4fa3"},{default:t(()=>[a("#")]),_:1}),a("基本用法")]),f,n(l,{"playground-ignore":""},{default:t(()=>[v]),_:1}),y,n(l,{"playground-ignore":""},{default:t(()=>[b]),_:1}),n(l,{"playground-ignore":""},{default:t(()=>[x]),_:1})])])}const A=c(h,[["render",k]]);export{A as default};
