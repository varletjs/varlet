import{_ as o,b as c,e as r,m as p,p as s,q as n,w as l,P as a}from"./index-hvUEgl9w.js";const i={components:{}},d={class:"varlet-site-doc"},h=s("h1",null,"原子化 CSS 支持",-1),_={class:"card"},j={id:"jie4shao4"},m=s("p",null,"我们提供了常见的 CSS 原子化框架预设，使访问组件库的基础样式变量更加容易，并且一致化了页面响应式断点。",-1),g={class:"card"},u={id:"UnoCSS"},f=s("p",null,[a("预设的详细定义"),s("a",{href:"https://github.com/varletjs/varlet/blob/main/packages/varlet-preset-unocss/src/index.ts"},"请看这里"),a("。")],-1),v=s("h4",null,"安装",-1),y=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," npm"),a(`
