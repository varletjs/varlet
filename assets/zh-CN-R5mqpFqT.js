import{_ as i,b as e,e as h,m as r,p as s,q as n,w as l,P as a,$ as o}from"./index-hvUEgl9w.js";const d={components:{}},p={class:"varlet-site-doc"},j=s("h1",null,"图标",-1),m={class:"card"},u={id:"jie4shao4"},_=s("p",null,[a("基于字体的图标库，也支持网络图片。 字体图标来自 "),s("a",{href:"https://materialdesignicons.com/"},"Material Design Icon"),a("。")],-1),g={class:"card"},f={id:"tu2biao1chi3cun4"},y=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`)])],-1),v={class:"card"},b={id:"tu2biao1yan2se4"},k=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),x={class:"card"},z={id:"shi3yong4tu2pian4"},w=s("p",null,[a("当传入的 "),s("code",null,"name"),a(" 是一个网络地址时，将会使用 "),s("code",null,"img"),a(" 标签以 "),s("code",null,"cover"),a(" 模式显示，"),s("code",null,"size"),a(" 为图片的宽高。")],-1),N=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),$={class:"card"},C={id:"dian3ji1shi4jian4"},S=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"script"),a(),s("span",{class:"hljs-attr"},"setup"),a(">")]),s("span",{class:"javascript"},[a(`
...
`),s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
  ...
  />`)]),a(`
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),V={class:"card"},q={id:"tu2biao1qie4huan4dong4hua4"},B=s("p",null,[a("当设置了 "),s("code",null,"transition(ms)"),a(" 并通过图标的 "),s("code",null,"name"),a(" 切换图标时，可以触发切换动画。")],-1),P=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"script"),a(),s("span",{class:"hljs-attr"},"setup"),a(">")]),s("span",{class:"javascript"},[a(`
...
`)])],-1),E={class:"card"},I={id:"zi4ding4yi4tu2biao1ku4"},A=s("p",null,[a("首先您需要设置您自己的字体，并引入到您的项目。 这里假设扩展一个名为 "),s("code",null,"my-icons"),a(" 的字体。")],-1),D=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"/* 设置字体 */"),a(`
...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),T=s("h2",null,"API",-1),G={class:"card"},H={id:"shu3xing4"},J=o("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>name</code></td><td>图标名称</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>size</code></td><td>尺寸</td><td><em>string | number</em></td><td><code>-</code></td></tr><tr><td><code>color</code></td><td>图标颜色, 只适用于字体图标</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>namespace</code></td><td>图标的命名空间, 可扩展自定义图标库</td><td><em>string</em></td><td><code>var-icon</code></td></tr><tr><td><code>animation-class</code></td><td>过渡动画类名</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>transition</code></td><td>过渡动画时间（ms）</td><td><em>string | number</em></td><td><code>0</code></td></tr></tbody></table>",1),K={class:"card"},L={id:"shi4jian4"},O=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"事件名"),s("th",null,"说明"),s("th",null,"参数")])]),s("tbody",null,[s("tr",null,[s("td",null,[s("code",null,"click")]),s("td",null,"点击图标时触发"),s("td",null,[s("code",null,"event: Event")])])])],-1),Q={class:"card"},R={id:"yang4shi4bian4liang4"},U=o('<p>以下为组件使用的 css 变量，可以使用 <a href="#/zh-CN/style-provider">StyleProvider 组件</a> 进行样式定制。</p><table><thead><tr><th>变量名</th><th>默认值</th></tr></thead><tbody><tr><td><code>--icon-size</code></td><td><code>20px</code></td></tr></tbody></table>',2);function W(X,Y,Z,ss,as,ns){const t=e("router-link"),c=e("var-site-code-example");return h(),r("div",p,[j,s("div",m,[s("h3",u,[n(t,{to:"#jie4shao4"},{default:l(()=>[a("#")]),_:1}),a("介绍")]),_]),s("div",g,[s("h3",f,[n(t,{to:"#tu2biao1chi3cun4"},{default:l(()=>[a("#")]),_:1}),a("图标尺寸")]),n(c,null,{default:l(()=>[y]),_:1})]),s("div",v,[s("h3",b,[n(t,{to:"#tu2biao1yan2se4"},{default:l(()=>[a("#")]),_:1}),a("图标颜色")]),n(c,null,{default:l(()=>[k]),_:1})]),s("div",x,[s("h3",z,[n(t,{to:"#shi3yong4tu2pian4"},{default:l(()=>[a("#")]),_:1}),a("使用图片")]),w,n(c,null,{default:l(()=>[N]),_:1})]),s("div",$,[s("h3",C,[n(t,{to:"#dian3ji1shi4jian4"},{default:l(()=>[a("#")]),_:1}),a("点击事件")]),n(c,null,{default:l(()=>[S]),_:1})]),s("div",V,[s("h3",q,[n(t,{to:"#tu2biao1qie4huan4dong4hua4"},{default:l(()=>[a("#")]),_:1}),a("图标切换动画")]),B,n(c,null,{default:l(()=>[P]),_:1})]),s("div",E,[s("h3",I,[n(t,{to:"#zi4ding4yi4tu2biao1ku4"},{default:l(()=>[a("#")]),_:1}),a("自定义图标库")]),A,n(c,{"playground-ignore":""},{default:l(()=>[D]),_:1}),F,n(c,{"playground-ignore":""},{default:l(()=>[M]),_:1})]),T,s("div",G,[s("h3",H,[n(t,{to:"#shu3xing4"},{default:l(()=>[a("#")]),_:1}),a("属性")]),J]),s("div",K,[s("h3",L,[n(t,{to:"#shi4jian4"},{default:l(()=>[a("#")]),_:1}),a("事件")]),O]),s("div",Q,[s("h3",R,[n(t,{to:"#yang4shi4bian4liang4"},{default:l(()=>[a("#")]),_:1}),a("样式变量")]),U])])}const ts=i(d,[["render",W]]);export{ts as default};
