...
`)])],-1);function w(k,B,I,S,$,U){const l=c("router-link"),t=c("var-site-code-example");return p(),i("div",h,[d,a("div",j,[a("h3",_,[e(l,{to:"#Intro"},{default:n(()=>[s("#")]),_:1}),s("Intro")]),m]),a("div",u,[a("h3",v,[e(l,{to:"#ImportStyle"},{default:n(()=>[s("#")]),_:1}),s("Import Style")]),e(t,{"playground-ignore":""},{default:n(()=>[g]),_:1})]),a("div",f,[a("h3",b,[e(l,{to:"#BasicUsage"},{default:n(()=>[s("#")]),_:1}),s("Basic Usage")]),y,e(t,null,{default:n(()=>[x]),_:1})])])}const V=o(r,[["render",w]]);export{V as default};
