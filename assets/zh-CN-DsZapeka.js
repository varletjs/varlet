import{G as e,L as t,N as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-DxIRHDbJ.js";import{t as c}from"./_plugin-vue_export-helper-BDNMzG2s.js";var l={components:{}},u={class:`varlet-site-doc`},d={class:`card`},f={id:`jie4shao4`},p={class:`card`},m={id:`ji1ben3shi3yong4`},h={class:`card`},g={id:`jia1zai4shi1bai4`},_={class:`card`},v={id:`ti2shi4wen2zi4`},y={class:`card`},b={id:`zu3he2`},x={class:`card`},S={id:`zhu4yi4`},C={class:`card`},w={id:`shu3xing4`},T={class:`card`},E={id:`fang1fa3`},D={class:`card`},O={id:`shi4jian4`},k={class:`card`},A={id:`cha1cao2`},j={class:`card`},M={id:`yang4shi4bian4liang4`};function N(c,l,N,P,F,I){let L=t(`router-link`),R=t(`var-site-code-example`);return n(),i(`div`,u,[l[36]||=r(`h1`,null,`无限滚动列表`,-1),r(`div`,d,[r(`h3`,f,[a(L,{to:`#jie4shao4`},{default:e(()=>[...l[0]||=[o(`#`,-1)]]),_:1}),l[1]||=o(`介绍`,-1)]),l[2]||=r(`p`,null,`无限滚动加载列表、触底加载，支持手动检查位置并加载。支持自定义加载状态、错误状态、数据加载完成状态。`,-1)]),r(`div`,p,[r(`h3`,m,[a(L,{to:`#ji1ben3shi3yong4`},{default:e(()=>[...l[3]||=[o(`#`,-1)]]),_:1}),l[4]||=o(`基本使用`,-1)]),l[6]||=r(`p`,null,[o(`当检测到滚动容器滚动到底部底部时会触发 `),r(`code`,null,`load`),o(` 事件，并会设置 `),r(`code`,null,`loading`),o(` 为 `),r(`code`,null,`true`),o(`，在加载结束时您需要手动设置 `),r(`code`,null,`loading`),o(` 为 `),r(`code`,null,`false`),o(`，表示加载结束。`)],-1),a(R,null,{default:e(()=>[...l[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`)])],-1)]]),_:1})]),r(`div`,h,[r(`h3`,g,[a(L,{to:`#jia1zai4shi1bai4`},{default:e(()=>[...l[7]||=[o(`#`,-1)]]),_:1}),l[8]||=o(`加载失败`,-1)]),l[10]||=r(`p`,null,[o(`您可以使用 `),r(`code`,null,`v-model:error`),o(` 手动设置错误状态，会展示错误提示，点击错误提示会帮您把 `),r(`code`,null,`error`),o(` 设置成 `),r(`code`,null,`false`),o(` 并再次触发 `),r(`code`,null,`load`),o(` 事件。`)],-1),a(R,null,{default:e(()=>[...l[9]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-list`),o(`>`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,_,[r(`h3`,v,[a(L,{to:`#ti2shi4wen2zi4`},{default:e(()=>[...l[11]||=[o(`#`,-1)]]),_:1}),l[12]||=o(`提示文字`,-1)]),a(R,null,{default:e(()=>[...l[13]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-list`),o(`>`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,y,[r(`h3`,b,[a(L,{to:`#zu3he2`},{default:e(()=>[...l[14]||=[o(`#`,-1)]]),_:1}),l[15]||=o(`组合`,-1)]),l[17]||=r(`p`,null,[o(`与 `),r(`code`,null,`PullRefresh`),o(` 组件结合使用即可实现上拉加载和下拉刷新的功能，需保证`),r(`code`,null,`PullRefresh`),o(` 容器高度不为 `),r(`code`,null,`0`),o(`。`)],-1),a(R,null,{default:e(()=>[...l[16]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
