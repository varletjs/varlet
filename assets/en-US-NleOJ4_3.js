import{b as i,m as o,p as a,q as l,Q as s,w as t,e as p,h as c}from"./index-j5HwO7IB.js";const h={components:{}},j={class:"varlet-site-doc"},d={class:"card"},u={id:"Intro"},m={class:"card"},g={id:"StyleBinding"},v={class:"card"},b={id:"FunctionBinding"},f={class:"card"},y={id:"SelectivelyEnableForDifferentDevices"};function k(w,n,x,E,B,O){const e=p("router-link"),r=p("var-site-code-example");return c(),o("div",j,[n[18]||(n[18]=a("h1",null,"Hover",-1)),a("div",d,[a("h3",u,[l(e,{to:"#Intro"},{default:t(()=>n[0]||(n[0]=[s("#")])),_:1}),n[1]||(n[1]=s("Intro"))]),n[2]||(n[2]=a("p",null,"Style binding is performed when the pointer hovers the binding element, and the current hovering state can also be obtained through a function, which supports selective enablement on desktop or mobile.",-1))]),a("div",m,[a("h3",g,[l(e,{to:"#StyleBinding"},{default:t(()=>n[3]||(n[3]=[s("#")])),_:1}),n[4]||(n[4]=s("Style Binding"))]),n[6]||(n[6]=a("p",null,"The style binding is performed when the pointer hovers over the bound element, and the style binding is canceled when the pointer leaves the element.",-1)),l(r,null,{default:t(()=>n[5]||(n[5]=[a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
