import{G as e,L as t,N as ee,c as n,d as te,g as r,h as i,m as a}from"./runtime-core.esm-bundler-DxIRHDbJ.js";import{t as ne}from"./_plugin-vue_export-helper-BDNMzG2s.js";var o={components:{}},s={class:`varlet-site-doc`},c={class:`card`},l={id:`Intro`},u={class:`card`},d={id:`BasicUsage`},f={class:`card`},p={id:`Variants`},m={class:`card`},h={id:`FilePreview`},g={class:`card`},_={id:`CustomPreview`},v={class:`card`},y={id:`UploadState`},b={class:`card`},x={id:`UseProgress`},S={class:`card`},C={id:`FileMaxlength`},w={class:`card`},T={id:`FileSizeLimit`},E={class:`card`},D={id:`FileListFilter`},O={class:`card`},k={id:`UploadPreprocessing`},A={class:`card`},j={id:`UploadButtonClickEvent`},M={class:`card`},N={id:`Disabled`},P={class:`card`},re={id:`Readonly`},F={class:`card`},I={id:`RemovePreprocessing`},L={class:`card`},R={id:`CustomizeUploadStyles`},z={class:`card`},B={id:`Validate`},V={class:`card`},H={id:`ValidatewithZod`},U={class:`card`},W={id:`CustomRenderFileList`},G={class:`card`},K={id:`CustomRemoveButton`},q={class:`card`},J={id:`Props`},Y={class:`card`},X={id:`VarFile`},ie={class:`card`},ae={id:`VarFileUtils`},oe={class:`card`},se={id:`Methods`},ce={class:`card`},Z={id:`Events`},le={class:`card`},ue={id:`Slots`},de={class:`card`},fe={id:`StyleVariables`};function pe(ne,o,pe,me,he,ge){let Q=t(`router-link`),$=t(`var-site-code-example`);return ee(),te(`div`,s,[o[91]||=n(`h1`,null,`Uploader`,-1),n(`div`,c,[n(`h3`,l,[r(Q,{to:`#Intro`},{default:e(()=>[...o[0]||=[i(`#`,-1)]]),_:1}),o[1]||=i(`Intro`,-1)]),o[2]||=n(`p`,null,[i(`It provides the ability to read files and preview pictures and videos. Get the file upload server by listening for `),n(`code`,null,`after-read`),i(` events.`)],-1)]),n(`div`,u,[n(`h3`,d,[r(Q,{to:`#BasicUsage`},{default:e(()=>[...o[3]||=[i(`#`,-1)]]),_:1}),o[4]||=i(`Basic Usage`,-1)]),r($,null,{default:e(()=>[...o[5]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,f,[n(`h3`,p,[r(Q,{to:`#Variants`},{default:e(()=>[...o[6]||=[i(`#`,-1)]]),_:1}),o[7]||=i(`Variants`,-1)]),o[9]||=a(`<p>Use <code>variant</code> to set the paper appearance of upload items. The supported variants are <code>standard</code>, <code>outlined</code>, and <code>filled</code>. Only the <code>standard</code> variant applies <code>elevation</code>.</p>`,1),r($,null,{default:e(()=>[...o[8]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`

`),n(`span`,{class:`hljs-keyword`},`const`),i(` standardFiles = ref([])
`),n(`span`,{class:`hljs-keyword`},`const`),i(` outlinedFiles = ref([])
`),n(`span`,{class:`hljs-keyword`},`const`),i(` filledFiles = ref([])
`)]),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`script`),i(`>`)]),i(`

`),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
  `),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`var-uploader`),i(),n(`span`,{class:`hljs-attr`},`v-model`),i(`=`),n(`span`,{class:`hljs-string`},`"standardFiles"`),i(),n(`span`,{class:`hljs-attr`},`variant`),i(`=`),n(`span`,{class:`hljs-string`},`"standard"`),i(` />`)]),i(`
  `),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`var-uploader`),i(),n(`span`,{class:`hljs-attr`},`v-model`),i(`=`),n(`span`,{class:`hljs-string`},`"outlinedFiles"`),i(),n(`span`,{class:`hljs-attr`},`variant`),i(`=`),n(`span`,{class:`hljs-string`},`"outlined"`),i(` />`)]),i(`
  `),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`var-uploader`),i(),n(`span`,{class:`hljs-attr`},`v-model`),i(`=`),n(`span`,{class:`hljs-string`},`"filledFiles"`),i(),n(`span`,{class:`hljs-attr`},`variant`),i(`=`),n(`span`,{class:`hljs-string`},`"filled"`),i(` />`)]),i(`
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,m,[n(`h3`,h,[r(Q,{to:`#FilePreview`},{default:e(()=>[...o[10]||=[i(`#`,-1)]]),_:1}),o[11]||=i(`File Preview`,-1)]),o[13]||=n(`p`,null,`By analyzing the file URL suffix name to determine the file type, support image and video preview.`,-1),r($,null,{default:e(()=>[...o[12]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,g,[n(`h3`,_,[r(Q,{to:`#CustomPreview`},{default:e(()=>[...o[14]||=[i(`#`,-1)]]),_:1}),o[15]||=i(`Custom Preview`,-1)]),r($,null,{default:e(()=>[...o[16]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,v,[n(`h3`,y,[r(Q,{to:`#UploadState`},{default:e(()=>[...o[17]||=[i(`#`,-1)]]),_:1}),o[18]||=i(`Upload State`,-1)]),o[20]||=n(`p`,null,[i(`Three uploading states, `),n(`code`,null,`loading`),i(`, `),n(`code`,null,`success`),i(` and `),n(`code`,null,`error`),i(`, are provided, and tool functions are provided to quickly obtain files with corresponding states.`)],-1),r($,null,{default:e(()=>[...o[19]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
  `),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`var-uploader`),i(),n(`span`,{class:`hljs-attr`},`v-model`),i(`=`),n(`span`,{class:`hljs-string`},`"files"`),i(` @`),n(`span`,{class:`hljs-attr`},`after-read`),i(`=`),n(`span`,{class:`hljs-string`},`"handleAfterRead"`),i(`/>`)]),i(`
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,b,[n(`h3`,x,[r(Q,{to:`#UseProgress`},{default:e(()=>[...o[21]||=[i(`#`,-1)]]),_:1}),o[22]||=i(`Use Progress`,-1)]),r($,null,{default:e(()=>[...o[23]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
  `),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`var-uploader`),i(),n(`span`,{class:`hljs-attr`},`v-model`),i(`=`),n(`span`,{class:`hljs-string`},`"files"`),i(` @`),n(`span`,{class:`hljs-attr`},`after-read`),i(`=`),n(`span`,{class:`hljs-string`},`"handleAfterRead"`),i(`/>`)]),i(`
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,S,[n(`h3`,C,[r(Q,{to:`#FileMaxlength`},{default:e(()=>[...o[24]||=[i(`#`,-1)]]),_:1}),o[25]||=i(`File Maxlength`,-1)]),r($,null,{default:e(()=>[...o[26]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,w,[n(`h3`,T,[r(Q,{to:`#FileSizeLimit`},{default:e(()=>[...o[27]||=[i(`#`,-1)]]),_:1}),o[28]||=i(`File Size Limit`,-1)]),o[30]||=n(`p`,null,[i(`If the limit is exceeded, the file will be blocked. You can get the file by listening for the `),n(`code`,null,`oversize`),i(` event.`)],-1),r($,null,{default:e(()=>[...o[29]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`)])],-1)]]),_:1})]),n(`div`,O,[n(`h3`,k,[r(Q,{to:`#UploadPreprocessing`},{default:e(()=>[...o[35]||=[i(`#`,-1)]]),_:1}),o[36]||=i(`Upload Preprocessing`,-1)]),o[38]||=n(`p`,null,[i(`Operate on a file by registering a `),n(`code`,null,`before-read`),i(` event that returns a false value to prevent the file from being read.`)],-1),r($,null,{default:e(()=>[...o[37]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { Snackbar } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'@varlet/ui'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,A,[n(`h3`,j,[r(Q,{to:`#UploadButtonClickEvent`},{default:e(()=>[...o[39]||=[i(`#`,-1)]]),_:1}),o[40]||=i(`Upload Button Click Event`,-1)]),o[42]||=n(`p`,null,[i(`By listen the `),n(`code`,null,`click-action`),i(` event, you can intercept the click behavior of the upload button, and manually trigger the browser to select the file through the `),n(`code`,null,`chooseFile`),i(` method in the callback.`)],-1),r($,null,{default:e(()=>[...o[41]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { Snackbar } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'@varlet/ui'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,M,[n(`h3`,N,[r(Q,{to:`#Disabled`},{default:e(()=>[...o[43]||=[i(`#`,-1)]]),_:1}),o[44]||=i(`Disabled`,-1)]),r($,null,{default:e(()=>[...o[45]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,P,[n(`h3`,re,[r(Q,{to:`#Readonly`},{default:e(()=>[...o[46]||=[i(`#`,-1)]]),_:1}),o[47]||=i(`Readonly`,-1)]),r($,null,{default:e(()=>[...o[48]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,F,[n(`h3`,I,[r(Q,{to:`#RemovePreprocessing`},{default:e(()=>[...o[49]||=[i(`#`,-1)]]),_:1}),o[50]||=i(`Remove Preprocessing`,-1)]),o[52]||=n(`p`,null,[i(`Before deleting the file, the `),n(`code`,null,`before-remove`),i(` event is triggered, and a falsy value is returned to prevent the delete operation.`)],-1),r($,null,{default:e(()=>[...o[51]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { Dialog } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'@varlet/ui'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,L,[n(`h3`,R,[r(Q,{to:`#CustomizeUploadStyles`},{default:e(()=>[...o[53]||=[i(`#`,-1)]]),_:1}),o[54]||=i(`Customize Upload Styles`,-1)]),r($,null,{default:e(()=>[...o[55]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,z,[n(`h3`,B,[r(Q,{to:`#Validate`},{default:e(()=>[...o[56]||=[i(`#`,-1)]]),_:1}),o[57]||=i(`Validate`,-1)]),o[59]||=n(`p`,null,[i(`The values are validated by passing in an array of validator, If the validator returns `),n(`code`,null,`true`),i(`, the validation passes. Other values are converted to text as a user prompt. The second argument is a collection of utility functions that can quickly get a collection of files that match the state.`)],-1),r($,null,{default:e(()=>[...o[58]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
  ...
  />`)]),i(`
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,V,[n(`h3`,H,[r(Q,{to:`#ValidatewithZod`},{default:e(()=>[...o[60]||=[i(`#`,-1)]]),_:1}),o[61]||=i(`Validate with Zod`,-1)]),r($,null,{default:e(()=>[...o[62]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`),n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
  ...
  />`)]),i(`
`),n(`span`,{class:`hljs-tag`},[i(`</`),n(`span`,{class:`hljs-name`},`template`),i(`>`)]),i(`
`)])],-1)]]),_:1})]),n(`div`,U,[n(`h3`,W,[r(Q,{to:`#CustomRenderFileList`},{default:e(()=>[...o[63]||=[i(`#`,-1)]]),_:1}),o[64]||=i(`Custom Render File List`,-1)]),o[66]||=n(`p`,null,[i(`You can use the `),n(`code`,null,`hide-list`),i(` to hide component files list, then you can render this list by custom.`)],-1),r($,null,{default:e(()=>[...o[65]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
...
`)])],-1)]]),_:1})]),n(`div`,G,[n(`h3`,K,[r(Q,{to:`#CustomRemoveButton`},{default:e(()=>[...o[67]||=[i(`#`,-1)]]),_:1}),o[68]||=i(`Custom Remove Button`,-1)]),r($,null,{default:e(()=>[...o[69]||=[n(`pre`,{class:`hljs`},[n(`code`,null,[n(`span`,{class:`hljs-tag`},[i(`<`),n(`span`,{class:`hljs-name`},`script`),i(),n(`span`,{class:`hljs-attr`},`setup`),i(`>`)]),n(`span`,{class:`javascript`},[i(`
`),n(`span`,{class:`hljs-keyword`},`import`),i(` { ref } `),n(`span`,{class:`hljs-keyword`},`from`),i(),n(`span`,{class:`hljs-string`},`'vue'`),i(`
