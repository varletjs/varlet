import{b as h,m as o,p as a,q as n,Q as s,w as t,$ as e,e as p,h as j}from"./index-DtCrA0ro.js";const d={components:{}},i={class:"varlet-site-doc"},m={class:"card"},g={id:"jie4shao4"},u={class:"card"},v={id:"biao3dan1shi4li4"},f={class:"card"},b={id:"biao3dan1shi4jian4"},y={class:"card"},k={id:"zi4ding4yi4biao3dan1zu3jian4"},w={class:"card"},x={id:"shu3xing4"},_={class:"card"},V={id:"fang1fa3"},D={class:"card"},T={id:"shi4jian4"},F={class:"card"},S={id:"cha1cao2"},z={class:"card"},B={id:"yang4shi4bian4liang4"};function C(M,l,N,P,$,W){const r=p("router-link"),c=p("var-site-code-example");return j(),o("div",i,[l[29]||(l[29]=a("h1",null,"表单",-1)),a("div",m,[a("h3",g,[n(r,{to:"#jie4shao4"},{default:t(()=>[...l[0]||(l[0]=[s("#",-1)])]),_:1}),l[1]||(l[1]=s("介绍",-1))]),l[2]||(l[2]=a("p",null,"提供了对所有表单组件进行控制的能力。",-1))]),a("div",u,[a("h3",v,[n(r,{to:"#biao3dan1shi4li4"},{default:t(()=>[...l[3]||(l[3]=[s("#",-1)])]),_:1}),l[4]||(l[4]=s("表单示例",-1))]),n(c,null,{default:t(()=>[...l[5]||(l[5]=[a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
...
`),a("span",{class:"hljs-keyword"},"const"),s(" emailSuggestions = computed("),a("span",{class:"hljs-function"},"() =>"),s(`
  [`),a("span",{class:"hljs-string"},"'@qq.com'"),s(", "),a("span",{class:"hljs-string"},"'@163.com'"),s(", "),a("span",{class:"hljs-string"},"'@gmail.com'"),s("].map("),a("span",{class:"hljs-function"},[s("("),a("span",{class:"hljs-params"},"suffix"),s(") =>")]),s(` {
    `),a("span",{class:"hljs-keyword"},"const"),s(" [prefix] = formData.email.split("),a("span",{class:"hljs-string"},"'@'"),s(`)
    `),a("span",{class:"hljs-keyword"},"return"),s(` {
      `),a("span",{class:"hljs-attr"},"label"),s(`: prefix + suffix,
      `),a("span",{class:"hljs-attr"},"value"),s(`: prefix + suffix,
    }
  })
)
  ...
  >`)]),s(`
    `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-space"),s(),a("span",{class:"hljs-attr"},"direction"),s("="),a("span",{class:"hljs-string"},'"column"'),s(),a("span",{class:"hljs-attr"},":size"),s("="),a("span",{class:"hljs-string"},'"[14, 0]"'),s(">")]),s(`
      ...
      `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-input"),s(`
        ...
        `),a("span",{class:"hljs-attr"},":rules"),s("="),a("span",{class:"hljs-string"},`"[v => !!v || '密码不能为空', (v) => v.length >= 8 || '密码长度不能低于8位']"`),s(`
      ...
      `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-auto-complete"),s(`
        `),a("span",{class:"hljs-attr"},"placeholder"),s("="),a("span",{class:"hljs-string"},'"请输入邮箱"'),s(`
        `),a("span",{class:"hljs-attr"},":rules"),s("="),a("span",{class:"hljs-string"},`"v => !!v || '邮箱不能为空'"`),s(`
        `),a("span",{class:"hljs-attr"},":options"),s("="),a("span",{class:"hljs-string"},'"emailSuggestions"'),s(`
        `),a("span",{class:"hljs-attr"},"v-model"),s("="),a("span",{class:"hljs-string"},'"formData.email"'),s(`
      />`)]),s(`
      ...
      `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-switch"),s(`
        `),a("span",{class:"hljs-attr"},"variant"),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1)])]),_:1})]),a("div",f,[a("h3",b,[n(r,{to:"#biao3dan1shi4jian4"},{default:t(()=>[...l[6]||(l[6]=[s("#",-1)])]),_:1}),l[7]||(l[7]=s("表单事件",-1))]),l[9]||(l[9]=a("p",null,"您也可以使用表单事件去处理表单行为",-1)),n(c,null,{default:t(()=>[...l[8]||(l[8]=[a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
...
`),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
  ...
  `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-form"),s(">")]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1)])]),_:1})]),a("div",y,[a("h3",k,[n(r,{to:"#zi4ding4yi4biao3dan1zu3jian4"},{default:t(()=>[...l[10]||(l[10]=[s("#",-1)])]),_:1}),l[11]||(l[11]=s("自定义表单组件",-1))]),l[13]||(l[13]=a("p",null,"如果希望自定义组件并接入表单组件的能力，案例如下。",-1)),n(c,{"playground-ignore":""},{default:t(()=>[...l[12]||(l[12]=[a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
...
`),a("span",{class:"hljs-keyword"},"const"),s(` props = defineProps({
  `),a("span",{class:"hljs-attr"},"modelValue"),s(": "),a("span",{class:"hljs-built_in"},"Boolean"),s(`,
  `),a("span",{class:"hljs-attr"},"disabled"),s(": "),a("span",{class:"hljs-built_in"},"Boolean"),s(`,
  `),a("span",{class:"hljs-attr"},"readonly"),s(": "),a("span",{class:"hljs-built_in"},"Boolean"),s(`,
