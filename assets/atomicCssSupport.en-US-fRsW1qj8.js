import{b as o,m as i,p as s,q as a,Q as n,w as t,e as p,h as d}from"./index-DA5cNuNL.js";const j={components:{}},m={class:"varlet-site-doc"},c={class:"card"},h={id:"Intro"},g={class:"card"},u={id:"UnoCSS"},f={class:"card"},v={id:"Tailwindcss"},w={class:"card"},y={id:"MoreOptions"},b={class:"card"},k={id:"Usage"};function x(C,l,S,V,U,D){const r=p("router-link"),e=p("var-site-code-example");return d(),i("div",m,[l[28]||(l[28]=s("h1",null,"Atomic CSS support",-1)),s("div",c,[s("h3",h,[a(r,{to:"#Intro"},{default:t(()=>[...l[0]||(l[0]=[n("#",-1)])]),_:1}),l[1]||(l[1]=n("Intro",-1))]),l[2]||(l[2]=s("p",null,"We've provided common CSS atomization framework presets, made it easier to access the component library's underlying style variables, and standardized page responsiveness breakpoints.",-1))]),s("div",g,[s("h3",u,[a(r,{to:"#UnoCSS"},{default:t(()=>[...l[3]||(l[3]=[n("#",-1)])]),_:1}),l[4]||(l[4]=n("UnoCSS",-1))]),l[7]||(l[7]=s("h4",null,"Install",-1)),a(e,{"playground-ignore":""},{default:t(()=>[...l[5]||(l[5]=[s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," npm"),n(`
