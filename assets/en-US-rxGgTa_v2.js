import{G as e,L as t,N as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-DxIRHDbJ.js";import{t as c}from"./_plugin-vue_export-helper-BDNMzG2s.js";var l={components:{}},u={class:`varlet-site-doc`},d={class:`card`},f={id:`Intro`},p={class:`card`},m={id:`FormExample`},h={class:`card`},g={id:`FormEvents`},_={class:`card`},v={id:`CustomFormComponent`},y={class:`card`},b={id:`Props`},x={class:`card`},S={id:`Methods`},C={class:`card`},w={id:`Events`},T={class:`card`},E={id:`Slots`},D={class:`card`},O={id:`StyleVariables`};function k(c,l,k,A,j,M){let N=t(`router-link`),P=t(`var-site-code-example`);return n(),i(`div`,u,[l[29]||=r(`h1`,null,`Form`,-1),r(`div`,d,[r(`h3`,f,[a(N,{to:`#Intro`},{default:e(()=>[...l[0]||=[o(`#`,-1)]]),_:1}),l[1]||=o(`Intro`,-1)]),l[2]||=r(`p`,null,`Provides the ability to control all form components.`,-1)]),r(`div`,p,[r(`h3`,m,[a(N,{to:`#FormExample`},{default:e(()=>[...l[3]||=[o(`#`,-1)]]),_:1}),l[4]||=o(`Form Example`,-1)]),a(P,null,{default:e(()=>[...l[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { computed, reactive, ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
...
`),r(`span`,{class:`hljs-keyword`},`const`),o(` formData = reactive({
  ...
  `),r(`span`,{class:`hljs-attr`},`otp`),o(`: `),r(`span`,{class:`hljs-string`},`''`),o(`,
  `),r(`span`,{class:`hljs-attr`},`email`),o(`: `),r(`span`,{class:`hljs-string`},`''`),o(`,
  `),r(`span`,{class:`hljs-attr`},`date`),o(`: `),r(`span`,{class:`hljs-string`},`''`),o(`,
  `),r(`span`,{class:`hljs-attr`},`datetimeRange`),o(`: [],
  `),r(`span`,{class:`hljs-attr`},`department`),o(`: `),r(`span`,{class:`hljs-string`},`''`),o(`,
  `),r(`span`,{class:`hljs-attr`},`period`),o(`: `),r(`span`,{class:`hljs-literal`},`undefined`),o(`,
  ...
  `),r(`span`,{class:`hljs-attr`},`range`),o(`: `),r(`span`,{class:`hljs-number`},`0`),o(`,
  ...
  `),r(`span`,{class:`hljs-attr`},`custom`),o(`: `),r(`span`,{class:`hljs-literal`},`false`),o(`,
})
...
`),r(`span`,{class:`hljs-keyword`},`const`),o(` suggestions = computed(`),r(`span`,{class:`hljs-function`},`() =>`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-form`),o(`
    ...
    `),r(`span`,{class:`hljs-attr`},`scroll-to-error-offset-y`),o(`=`),r(`span`,{class:`hljs-string`},`"14.4vmin"`),o(`
  >`)]),o(`
    `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-space`),o(),r(`span`,{class:`hljs-attr`},`direction`),o(`=`),r(`span`,{class:`hljs-string`},`"column"`),o(),r(`span`,{class:`hljs-attr`},`:size`),o(`=`),r(`span`,{class:`hljs-string`},`"['4vmin', 0]"`),o(`>`)]),o(`
      ...
      `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-auto-complete`),o(`
        ...
        `),r(`span`,{class:`hljs-attr`},`variant`),o(`=`),r(`span`,{class:`hljs-string`},`"outlined"`),o(`
        `),r(`span`,{class:`hljs-attr`},`placeholder`),o(`=`),r(`span`,{class:`hljs-string`},`"Please input email"`),o(`
        `),r(`span`,{class:`hljs-attr`},`:rules`),o(`=`),r(`span`,{class:`hljs-string`},`"[(v) => !!v || 'The email cannot be empty']"`),o(`
        `),r(`span`,{class:`hljs-attr`},`:options`),o(`=`),r(`span`,{class:`hljs-string`},`"suggestions"`),o(`
      />`)]),o(`
      `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-date-input`),o(`
        `),r(`span`,{class:`hljs-attr`},`v-model`),o(`=`),r(`span`,{class:`hljs-string`},`"formData.date"`),o(`
        `),r(`span`,{class:`hljs-attr`},`variant`),o(`=`),r(`span`,{class:`hljs-string`},`"outlined"`),o(`
        `),r(`span`,{class:`hljs-attr`},`placeholder`),o(`=`),r(`span`,{class:`hljs-string`},`"Please select date"`),o(`
        `),r(`span`,{class:`hljs-attr`},`:rules`),o(`=`),r(`span`,{class:`hljs-string`},`"[(v) => !!v || 'A date must be selected']"`),o(`
      />`)]),o(`
      `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-date-input`),o(`
        `),r(`span`,{class:`hljs-attr`},`v-model`),o(`=`),r(`span`,{class:`hljs-string`},`"formData.datetimeRange"`),o(`
        `),r(`span`,{class:`hljs-attr`},`variant`),o(`=`),r(`span`,{class:`hljs-string`},`"outlined"`),o(`
        `),r(`span`,{class:`hljs-attr`},`type`),o(`=`),r(`span`,{class:`hljs-string`},`"datetime"`),o(`
        `),r(`span`,{class:`hljs-attr`},`range`),o(`
        `),r(`span`,{class:`hljs-attr`},`placeholder`),o(`=`),r(`span`,{class:`hljs-string`},`"Please select datetime range"`),o(`
        `),r(`span`,{class:`hljs-attr`},`:rules`),o(`=`),r(`span`,{class:`hljs-string`},`"[(v) => v.length === 2 || 'A datetime range must be selected']"`),o(`
      />`)]),o(`
      ...
      `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-select`),o(`>`)]),o(`
      `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-segmented-buttons`),o(`
        `),r(`span`,{class:`hljs-attr`},`v-model`),o(`=`),r(`span`,{class:`hljs-string`},`"formData.period"`),o(`
        `),r(`span`,{class:`hljs-attr`},`:rules`),o(`=`),r(`span`,{class:`hljs-string`},`"[(v) => !!v || 'A period must be selected']"`),o(`
      >`)]),o(`
        `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-segmented-button`),o(),r(`span`,{class:`hljs-attr`},`checked-value`),o(`=`),r(`span`,{class:`hljs-string`},`"day"`),o(`>`)]),o(`Day`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-segmented-button`),o(`>`)]),o(`
        `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-segmented-button`),o(),r(`span`,{class:`hljs-attr`},`checked-value`),o(`=`),r(`span`,{class:`hljs-string`},`"week"`),o(`>`)]),o(`Week`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-segmented-button`),o(`>`)]),o(`
        `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-segmented-button`),o(),r(`span`,{class:`hljs-attr`},`checked-value`),o(`=`),r(`span`,{class:`hljs-string`},`"month"`),o(`>`)]),o(`Month`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-segmented-button`),o(`>`)]),o(`
      `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-segmented-buttons`),o(`>`)]),o(`
      ...
      `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-otp-input`),o(`
        `),r(`span`,{class:`hljs-attr`},`v-model`),o(`=`),r(`span`,{class:`hljs-string`},`"formData.otp"`),o(`
        `),r(`span`,{class:`hljs-attr`},`variant`),o(`=`),r(`span`,{class:`hljs-string`},`"outlined"`),o(`
        `),r(`span`,{class:`hljs-attr`},`:rules`),o(`=`),r(`span`,{class:`hljs-string`},`"[v => !!v || 'The OTP cannot be empty', (v) => v.length === 6 || 'The OTP length must be 6']"`),o(`
      />`)]),o(`
    ...
    `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-custom-form-component`),o(`
      `),r(`span`,{class:`hljs-attr`},`v-model`),o(`=`),r(`span`,{class:`hljs-string`},`"formData.custom"`),o(`
      `),r(`span`,{class:`hljs-attr`},`extra-message`),o(`=`),r(`span`,{class:`hljs-string`},`"Extra message"`),o(`
      `),r(`span`,{class:`hljs-attr`},`:rules`),o(`=`),r(`span`,{class:`hljs-string`},`"[(v) => !!v || 'Please check it']"`),o(`
    >`)]),o(`
      Click toggle
    `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-custom-form-component`),o(`>`)]),o(`
  ...
  `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-space`),o(`>`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,h,[r(`h3`,g,[a(N,{to:`#FormEvents`},{default:e(()=>[...l[6]||=[o(`#`,-1)]]),_:1}),l[7]||=o(`Form Events`,-1)]),l[9]||=r(`p`,null,`You can also use form events to handle form behavior.`,-1),a(P,null,{default:e(()=>[...l[8]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-form`),o(`>`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,_,[r(`h3`,v,[a(N,{to:`#CustomFormComponent`},{default:e(()=>[...l[10]||=[o(`#`,-1)]]),_:1}),l[11]||=o(`Custom Form Component`,-1)]),l[13]||=r(`p`,null,`If you want to customize the component and access the ability of the form component, the case is as follows.`,-1),a(P,{"playground-ignore":``},{default:e(()=>[...l[12]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
