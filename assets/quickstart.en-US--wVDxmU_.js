...
`)])],-1),x={class:"card"},I={id:"ComponentsPlayground"},V=s("p",null,[a("We provide a web version of the component editor, which is convenient for you to quickly get started with each component of the component library, edit it online, share it with others, or download the code package to run locally. You can click the "),s("code",null,"{...}"),a(" icon in the upper right corner of the page or "),s("a",{href:"https://varlet.gitee.io/varlet-ui-playground"},"go here"),a(".")],-1),A={class:"card"},C={id:"Filepathnote"},B=s("p",null,[a("In "),s("code",null,"@varlet/ui@2.7.0"),a(" and later versions, we recommend using the following file import method with omitting the suffix to be compatible with "),s("code",null,"js"),a(" and "),s("code",null,"mjs")],-1),N=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"import"),a(),s("span",{class:"hljs-string"},"'@varlet/ui/es/style'"),a(`
