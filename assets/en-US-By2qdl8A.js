import{G as e,L as t,N as n,c as r,d as i,g as a,h as o}from"./runtime-core.esm-bundler-5xw830oL.js";import{t as s}from"./_plugin-vue_export-helper-V-yks4gF.js";var c={components:{}},l={class:`varlet-site-doc`},u={class:`card`},d={id:`Intro`},f={class:`card`},p={id:`ImportStyle`},m={class:`card`},h={id:`BasicUsage`};function g(s,c,g,_,v,y){let b=t(`router-link`),x=t(`var-site-code-example`);return n(),i(`div`,l,[c[10]||=r(`h1`,null,`Elevation`,-1),r(`div`,u,[r(`h3`,d,[a(b,{to:`#Intro`},{default:e(()=>[...c[0]||=[o(`#`,-1)]]),_:1}),c[1]||=o(`Intro`,-1)]),c[2]||=r(`p`,null,[o(`The component library provides a shadow elevation effect based on the `),r(`code`,null,`Material`),o(` specification to represent the dimensionality of an element.`)],-1)]),r(`div`,f,[r(`h3`,p,[a(b,{to:`#ImportStyle`},{default:e(()=>[...c[3]||=[o(`#`,-1)]]),_:1}),c[4]||=o(`Import Style`,-1)]),a(x,{"playground-ignore":``},{default:e(()=>[...c[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-keyword`},`import`),o(),r(`span`,{class:`hljs-string`},`'@varlet/ui/es/styles/elevation.css'`),o(`
`)])],-1)]]),_:1})]),r(`div`,m,[r(`h3`,h,[a(b,{to:`#BasicUsage`},{default:e(()=>[...c[6]||=[o(`#`,-1)]]),_:1}),c[7]||=o(`Basic Usage`,-1)]),c[9]||=r(`p`,null,[o(`Shadows are divided into `),r(`code`,null,`0-24`),o(` levels, and the higher the level, the higher the altitude.`)],-1),a(x,null,{default:e(()=>[...c[8]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
