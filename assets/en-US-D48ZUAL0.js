import{G as e,L as t,N as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-5xw830oL.js";import{t as c}from"./_plugin-vue_export-helper-V-yks4gF.js";var l={components:{}},u={class:`varlet-site-doc`},d={class:`card`},f={id:`Intro`},p={class:`card`},m={id:`ComponentCall`},h={class:`card`},g={id:`FunctionCall`},_={class:`card`},v={id:`Props`},y={class:`card`},b={id:`Slots`};function x(c,l,x,S,C,w){let T=t(`router-link`),E=t(`var-site-code-example`);return n(),i(`div`,u,[l[16]||=r(`h1`,null,`Style Provider`,-1),r(`div`,d,[r(`h3`,f,[a(T,{to:`#Intro`},{default:e(()=>[...l[0]||=[o(`#`,-1)]]),_:1}),l[1]||=o(`Intro`,-1)]),l[2]||=r(`p`,null,[o(`Style variables can be easily mounted through the StyleProvider component. The component provides two calling methods: `),r(`code`,null,`component calling`),o(` and `),r(`code`,null,`functional calling`),o(`.`)],-1)]),r(`div`,p,[r(`h3`,m,[a(T,{to:`#ComponentCall`},{default:e(()=>[...l[3]||=[o(`#`,-1)]]),_:1}),l[4]||=o(`Component Call`,-1)]),l[6]||=r(`p`,null,[o(`Component calls can have a scope of custom component styles, Scope contamination is avoided. Note that some elements sent outside the StyleProvider using the `),r(`code`,null,`teleport`),o(` will not work.`)],-1),a(E,null,{default:e(()=>[...l[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
