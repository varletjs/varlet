import{b as r,m as i,p as s,q as n,Q as a,w as t,e as p,h as d}from"./index-Cr7vS9Mv.js";const j={components:{}},m={class:"varlet-site-doc"},u={class:"card"},c={id:"jie4shao4"},h={class:"card"},g={id:"ji1ben3yong4fa3"};function f(v,l,y,_,b,x){const o=p("router-link"),e=p("var-site-code-example");return d(),i("div",m,[l[10]||(l[10]=s("h1",null,"默认值定制",-1)),s("div",u,[s("h3",c,[n(o,{to:"#jie4shao4"},{default:t(()=>l[0]||(l[0]=[a("#")])),_:1}),l[1]||(l[1]=a("介绍"))]),l[2]||(l[2]=s("p",null,"组件库提供对组件属性的默认值进行定制的能力。",-1))]),s("div",h,[s("h3",g,[n(o,{to:"#ji1ben3yong4fa3"},{default:t(()=>l[3]||(l[3]=[a("#")])),_:1}),l[4]||(l[4]=a("基本用法"))]),l[8]||(l[8]=s("p",null,[a("通过组件提供的静态方法 "),s("code",null,"setPropsDefaults"),a(" 对组件的属性定义进行定制。需要注意的是，属性定制只对声明式组件生效，并且定制行为应在组件初始化之前。")],-1)),n(e,{"playground-ignore":""},{default:t(()=>l[5]||(l[5]=[s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// main.ts"),a(`
