import{G as e,L as t,N as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-5xw830oL.js";import{t as c}from"./_plugin-vue_export-helper-V-yks4gF.js";import{n as l,t as u}from"./ResponsiveObject-F1MvUCAp.js";var d={components:{BasicExample:l,ObjectExample:u}},f={class:`varlet-site-doc`},p={class:`card`},m={id:`Intro`},h={class:`card`},g={id:`GirdSystem`},_={class:`card`},v={id:`Offset`},y={class:`card`},b={id:`Alignment`},x={class:`card`},S={id:`ResponsiveLayout`},C={class:`varlet-component-preview`},w={class:`varlet-component-preview`},T={class:`card`},E={id:`Props`},D={class:`card`},O={id:`Events`},k={class:`card`},A={id:`Slots`};function j(c,l,u,d,j,M){let N=t(`router-link`),P=t(`var-site-code-example`),F=t(`basic-example`),I=t(`object-example`);return n(),i(`div`,f,[l[29]||=r(`h1`,null,`Layout`,-1),r(`div`,p,[r(`h3`,m,[a(N,{to:`#Intro`},{default:e(()=>[...l[0]||=[o(`#`,-1)]]),_:1}),l[1]||=o(`Intro`,-1)]),l[2]||=r(`p`,null,[o(`The component library provides two auxiliary layout components, `),r(`code`,null,`<var-row/>`),o(` and `),r(`code`,null,`<var-col/>`),o(`, so that you can layout more efficiently.`)],-1)]),r(`div`,h,[r(`h3`,g,[a(N,{to:`#GirdSystem`},{default:e(()=>[...l[3]||=[o(`#`,-1)]]),_:1}),l[4]||=o(`Gird System`,-1)]),a(P,null,{default:e(()=>[...l[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[o("The `"),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-row`),o(`/>`)]),o("` component divides a row into 24 columns of grids (24 copies), `"),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-col`),o(`/>`)]),o("` provides the `span` attribute to set the number of copies of a column, and the `offset` attribute to set a column the number of copies offset,\nThe `gutter` property sets column spacing.\n")])],-1)]]),_:1}),a(P,null,{default:e(()=>[...l[6]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
...
`)])],-1)]]),_:1})]),r(`div`,_,[r(`h3`,v,[a(N,{to:`#Offset`},{default:e(()=>[...l[7]||=[o(`#`,-1)]]),_:1}),l[8]||=o(`Offset`,-1)]),a(P,null,{default:e(()=>[...l[9]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-row`),o(),r(`span`,{class:`hljs-attr`},`:gutter`),o(`=`),r(`span`,{class:`hljs-string`},`"[10, 10]"`),o(`>`)]),o(`
...
`)]),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`style`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,x,[r(`h3`,S,[a(N,{to:`#ResponsiveLayout`},{default:e(()=>[...l[14]||=[o(`#`,-1)]]),_:1}),l[15]||=o(`Responsive Layout`,-1)]),l[18]||=r(`h4`,null,`Basic Usage`,-1),r(`div`,C,[a(F)]),a(P,null,{default:e(()=>[...l[16]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
...
`)]),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`style`),o(`>`)]),o(`
`)])],-1)]]),_:1}),l[19]||=r(`h4`,null,`Column Props Object`,-1),r(`div`,w,[a(I)]),a(P,null,{default:e(()=>[...l[17]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-row`),o(),r(`span`,{class:`hljs-attr`},`:gutter`),o(`=`),r(`span`,{class:`hljs-string`},`"10"`),o(`>`)]),o(`
