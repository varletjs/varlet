...
`)])],-1),A={class:"card"},D={id:"CustomIcons"},F=s("p",null,[a("First you need to set up your own font and install it into your project. Let's assume that we extend a font named "),s("code",null,"my-icons"),a(".")],-1),$=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"/* Set the font */"),a(`
...
`)])],-1),T=s("p",null,[a("Here you have successfully extended your icon library. So "),s("code",null,"my-icon"),a(" is your font "),s("code",null,"namespace"),a(". You can use it this way:")],-1),B=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
