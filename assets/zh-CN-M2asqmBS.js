import{G as e,L as t,N as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-DxIRHDbJ.js";import{t as c}from"./_plugin-vue_export-helper-BDNMzG2s.js";var l={components:{}},u={class:`varlet-site-doc`},d={class:`card`},f={id:`jie4shao4`},p={class:`card`},m={id:`ji1ben3shi3yong4`},h={class:`card`},g={id:`zu3he2`},_={class:`card`},v={id:`zhu4yi4`},y={class:`card`},b={id:`shu3xing4`},x={class:`card`},S={id:`shi4jian4`},C={class:`card`},w={id:`cha1cao2`},T={class:`card`},E={id:`yang4shi4bian4liang4`};function D(c,l,D,O,k,A){let j=t(`router-link`),M=t(`var-site-code-example`);return n(),i(`div`,u,[l[27]||=r(`h1`,null,`下拉刷新`,-1),r(`div`,d,[r(`h3`,f,[a(j,{to:`#jie4shao4`},{default:e(()=>[...l[0]||=[o(`#`,-1)]]),_:1}),l[1]||=o(`介绍`,-1)]),l[2]||=r(`p`,null,`用于提供下拉刷新的交互操作。`,-1)]),r(`div`,p,[r(`h3`,m,[a(j,{to:`#ji1ben3shi3yong4`},{default:e(()=>[...l[3]||=[o(`#`,-1)]]),_:1}),l[4]||=o(`基本使用`,-1)]),l[6]||=r(`p`,null,[o(`下拉到刷新位置时松开会触发 `),r(`code`,null,`refresh`),o(` 事件， 在事件开始时将 `),r(`code`,null,`v-model`),o(` 设置为 `),r(`code`,null,`true`),o(` 表示正在加载，完成后将 `),r(`code`,null,`v-model`),o(` 设置为 `),r(`code`,null,`false`),o(` 表示加载结束。`)],-1),a(M,null,{default:e(()=>[...l[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,h,[r(`h3`,g,[a(j,{to:`#zu3he2`},{default:e(()=>[...l[7]||=[o(`#`,-1)]]),_:1}),l[8]||=o(`组合`,-1)]),l[10]||=r(`p`,null,[o(`与 `),r(`code`,null,`List`),o(` 组件结合使用即可实现上拉加载和下拉刷新的功能，需保证 `),r(`code`,null,`PullRefresh`),o(` 容器高度不为 `),r(`code`,null,`0`),o(`。`)],-1),a(M,null,{default:e(()=>[...l[9]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-pull-refresh`),o(`>`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,_,[r(`h3`,v,[a(j,{to:`#zhu4yi4`},{default:e(()=>[...l[11]||=[o(`#`,-1)]]),_:1}),l[12]||=o(`注意`,-1)]),l[14]||=r(`p`,null,[o(`当 `),r(`code`,null,`PullRefresh`),o(` 容器高度为 `),r(`code`,null,`0`),o(` 时会导致下拉功能失效，所以需保证其子元素高度`),r(`strong`,null,`不为`),o(),r(`code`,null,`0`),o(` 或为 `),r(`code`,null,`PullRefresh`),o(` 容器设置高度:`)],-1),a(M,{"playground-ignore":``},{default:e(()=>[...l[13]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-pull-refresh`),o(`>`)]),o(`
