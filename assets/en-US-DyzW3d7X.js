import{G as e,L as t,N as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-DxIRHDbJ.js";import{t as c}from"./_plugin-vue_export-helper-BDNMzG2s.js";var l={components:{}},u={class:`varlet-site-doc`},d={class:`card`},f={id:`Intro`},p={class:`card`},m={id:`BasicUsage`},h={class:`card`},g={id:`ModifyTitle`},_={class:`card`},v={id:`ActionDisabled`},y={class:`card`},b={id:`DisableCloseOnClickAction`},x={class:`card`},S={id:`CustomActionStyles`},C={class:`card`},w={id:`BasicUsage`},T={class:`card`},E={id:`ModifyTitle`},D={class:`card`},O={id:`ActionDisabled`},k={class:`card`},A={id:`DisableCloseOnClickAction`},j={class:`card`},M={id:`CustomActionStyles`},N={class:`card`},P={id:`Props`},F={class:`card`},I={id:`Events`},L={class:`card`},R={id:`Methods`},z={class:`card`},B={id:`ActionSheetOptions`},V={class:`card`},H={id:`ActionSheetAction`},U={class:`card`},W={id:`Slots`},G={class:`card`},K={id:`StyleVariables`};function q(c,l,q,J,Y,X){let Z=t(`router-link`),Q=t(`var-site-code-example`);return n(),i(`div`,u,[l[57]||=r(`h1`,null,`ActionSheet`,-1),r(`div`,d,[r(`h3`,f,[a(Z,{to:`#Intro`},{default:e(()=>[...l[0]||=[o(`#`,-1)]]),_:1}),l[1]||=o(`Intro`,-1)]),l[2]||=r(`p`,null,[o(`An action sheet pops up to give the user the ability to select options. `),r(`code`,null,`ActionSheet`),o(` Functional and component use methods are provided, and there is no essential difference between the two effects and parameters. The function returns a `),r(`code`,null,`Promise`),o(`, on selection return `),r(`code`,null,`action`),o(`. Click modal close to return `),r(`code`,null,`close`),o(`.`)],-1)]),l[58]||=r(`h2`,null,`Function Call`,-1),r(`div`,p,[r(`h3`,m,[a(Z,{to:`#BasicUsage`},{default:e(()=>[...l[3]||=[o(`#`,-1)]]),_:1}),l[4]||=o(`Basic Usage`,-1)]),a(Q,null,{default:e(()=>[...l[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,h,[r(`h3`,g,[a(Z,{to:`#ModifyTitle`},{default:e(()=>[...l[6]||=[o(`#`,-1)]]),_:1}),l[7]||=o(`Modify Title`,-1)]),a(Q,null,{default:e(()=>[...l[8]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { Snackbar, ActionSheet } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'@varlet/ui'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,_,[r(`h3`,v,[a(Z,{to:`#ActionDisabled`},{default:e(()=>[...l[9]||=[o(`#`,-1)]]),_:1}),l[10]||=o(`Action Disabled`,-1)]),l[12]||=r(`p`,null,[o(`The option is passed `),r(`code`,null,`disabled`),o(` to leave the action in the disabled state.`)],-1),a(Q,null,{default:e(()=>[...l[11]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { Snackbar, ActionSheet } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'@varlet/ui'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,x,[r(`h3`,S,[a(Z,{to:`#CustomActionStyles`},{default:e(()=>[...l[17]||=[o(`#`,-1)]]),_:1}),l[18]||=o(`Custom Action Styles`,-1)]),l[20]||=r(`p`,null,[o(`Options provide parameters to configure the style. See the `),r(`code`,null,`Action`),o(` data structure for options.`)],-1),a(Q,null,{default:e(()=>[...l[19]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { Snackbar, ActionSheet } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'@varlet/ui'`),o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { h } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`

`),r(`span`,{class:`hljs-keyword`},`const`),o(` svgIcon = h(`),r(`span`,{class:`hljs-string`},`'svg'`),o(`, { `),r(`span`,{class:`hljs-attr`},`viewBox`),o(`: `),r(`span`,{class:`hljs-string`},`'0 0 24 24'`),o(`, `),r(`span`,{class:`hljs-attr`},`style`),o(`: { `),r(`span`,{class:`hljs-attr`},`width`),o(`: `),r(`span`,{class:`hljs-string`},`'1em'`),o(`, `),r(`span`,{class:`hljs-attr`},`height`),o(`: `),r(`span`,{class:`hljs-string`},`'1em'`),o(` } }, [
  h(`),r(`span`,{class:`hljs-string`},`'path'`),o(`, {
    `),r(`span`,{class:`hljs-attr`},`fill`),o(`: `),r(`span`,{class:`hljs-string`},`'currentColor'`),o(`,
    `),r(`span`,{class:`hljs-attr`},`d`),o(`: `),r(`span`,{class:`hljs-string`},`'M12 2 2 7l10 5 10-5zm0 7.8L6.45 7 12 4.2 17.55 7zm-8 1.7 8 4 8-4v2.2l-8 4-8-4zm0 4 8 4 8-4v2.2l-8 4-8-4z'`),o(`,
  }),
])
...
`),r(`span`,{class:`hljs-keyword`},`async`),o(),r(`span`,{class:`hljs-function`},[r(`span`,{class:`hljs-keyword`},`function`),o(),r(`span`,{class:`hljs-title`},`handleSelect`),o(`(`),r(`span`,{class:`hljs-params`}),o(`) `)]),o(`{
  `),r(`span`,{class:`hljs-keyword`},`const`),o(` action = `),r(`span`,{class:`hljs-keyword`},`await`),o(` ActionSheet({ 
    `),r(`span`,{class:`hljs-attr`},`actions`),o(`: [
      ...
      {
        `),r(`span`,{class:`hljs-attr`},`name`),o(`: `),r(`span`,{class:`hljs-string`},`'Item 02'`),o(`,
        `),r(`span`,{class:`hljs-attr`},`icon`),o(`: svgIcon,
...
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),l[59]||=r(`h2`,null,`Component Call`,-1),r(`div`,C,[r(`h3`,w,[a(Z,{to:`#BasicUsage`},{default:e(()=>[...l[21]||=[o(`#`,-1)]]),_:1}),l[22]||=o(`Basic Usage`,-1)]),a(Q,null,{default:e(()=>[...l[23]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  />`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,T,[r(`h3`,E,[a(Z,{to:`#ModifyTitle`},{default:e(()=>[...l[24]||=[o(`#`,-1)]]),_:1}),l[25]||=o(`Modify Title`,-1)]),a(Q,null,{default:e(()=>[...l[26]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { Snackbar } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'@varlet/ui'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  />`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,D,[r(`h3`,O,[a(Z,{to:`#ActionDisabled`},{default:e(()=>[...l[27]||=[o(`#`,-1)]]),_:1}),l[28]||=o(`Action Disabled`,-1)]),a(Q,null,{default:e(()=>[...l[29]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { Snackbar } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'@varlet/ui'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  />`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,k,[r(`h3`,A,[a(Z,{to:`#DisableCloseOnClickAction`},{default:e(()=>[...l[30]||=[o(`#`,-1)]]),_:1}),l[31]||=o(`Disable Close On Click Action`,-1)]),a(Q,null,{default:e(()=>[...l[32]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { Snackbar } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'@varlet/ui'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  />`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,j,[r(`h3`,M,[a(Z,{to:`#CustomActionStyles`},{default:e(()=>[...l[33]||=[o(`#`,-1)]]),_:1}),l[34]||=o(`Custom Action Styles`,-1)]),a(Q,null,{default:e(()=>[...l[35]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
