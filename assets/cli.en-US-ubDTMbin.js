...
/zh-CN/changelog
/en-US/changelog
`)],-1),M={class:"card"},B={id:"Commandrelated"},L=e("h4",null,"Start the development server",-1),A=e("pre",{class:"hljs"},[e("code",null,[t(`varlet-cli dev
`),e("span",{class:"hljs-meta"},"#"),e("span",{class:"bash"}," force mode"),t(`
varlet-cli dev -f
`),e("span",{class:"hljs-meta"},"#"),e("span",{class:"bash"}," draft mode"),t(`
varlet-cli dev -d
`)])],-1),P=e("h4",null,"Build a documentation site",-1),I=e("pre",{class:"hljs"},[e("code",null,`varlet-cli build
`)],-1),O=e("h4",null,"Preview documentation site",-1),Q=e("pre",{class:"hljs"},[e("code",null,`varlet-cli preview
`)],-1),G=e("h4",null,"Compile component library",-1),U=e("pre",{class:"hljs"},[e("code",null,`varlet-cli compile
`)],-1),q=e("h4",null,"Compile style vars types declaration file",-1),F=e("pre",{class:"hljs"},[e("code",null,`varlet-cli compile:style-vars
`)],-1),$=e("h4",null,"Run VSCode extension development environment",-1),H=e("pre",{class:"hljs"},[e("code",null,`varlet-cli dev:extension
...
`)],-1),ee=e("h4",null,"Execute a unit test",-1),te=e("pre",{class:"hljs"},[e("code",null,`varlet-cli test -c <componentName>
`)],-1),oe=e("h4",null,"Execute unit tests in watch mode",-1),de=e("pre",{class:"hljs"},[e("code",null,`varlet-cli test -w
`)],-1),ne=e("h4",null,"Execute unit tests and report coverage",-1),le=e("pre",{class:"hljs"},[e("code",null,`varlet-cli test -cov
`)],-1),se=e("h4",null,"Lint the code",-1),ce=e("pre",{class:"hljs"},[e("code",null,`varlet-cli lint
`)],-1),re=e("h4",null,"Lint git commit message",-1),ie=e("pre",{class:"hljs"},[e("code",null,`varlet-cli commit-lint
`)],-1),ae=e("h4",null,"Show checklist",-1),he=e("pre",{class:"hljs"},[e("code",null,`varlet-cli checklist
`)],-1),ue=e("h4",null,"Generate changelog",-1),pe=e("pre",{class:"hljs"},[e("code",null,`varlet-cli changelog
`)],-1),me=e("h4",null,"Release component library",-1),ge=e("pre",{class:"hljs"},[e("code",null,`varlet-cli release
`)],-1),_e=e("h4",null,"Generate a project template",-1),fe=e("pre",{class:"hljs"},[e("code",null,[t(`varlet-cli gen
...
`)])],-1),ve=e("h4",null,"Create a component template file",-1),be=e("pre",{class:"hljs"},[e("code",null,[t(`varlet-cli create
`),e("span",{class:"hljs-meta"},`
#`),e("span",{class:"bash"}," Options"),t(`
-n
--name
...
--locale
  Need to support internationalization
`)])],-1),ye={class:"card"},je={id:"Notebeforepublish"},xe=e("ol",null,[e("li",null,[e("code",null,"npm"),t(" repository registry must set to "),e("code",null,"npm"),t(" official mirror")]),e("li",null,[t("Execute "),e("code",null,"npm login"),t(" to log in")])],-1),Ce={class:"card"},Te={id:"Q&A"},we=e("h4",null,"How to solve failure of installing sharp ?",-1),ke=e("ul",null,[e("li",null,"You can choose to change mirror site which contains binaries for both sharp and libvips.")],-1),Se=e("pre",{class:"hljs"},[e("code",null,`pnpm config set sharp_binary_host "https://npmmirror.com/mirrors/sharp"
pnpm config set sharp_libvips_binary_host "https://npmmirror.com/mirrors/sharp-libvips"
`)],-1);function Ve(De,Ne,Ee,Re,ze,Me){const l=s("router-link"),n=s("var-site-code-example");return a(),i("div",u,[p,e("div",m,[e("h3",g,[o(l,{to:"#Intro"},{default:d(()=>[t("#")]),_:1}),t("Intro")]),_]),e("div",f,[e("h3",v,[o(l,{to:"#Features"},{default:d(()=>[t("#")]),_:1}),t("Features")]),b]),e("div",y,[e("h3",j,[o(l,{to:"#Quickstart"},{default:d(()=>[t("#")]),_:1}),t("Quickstart")]),x,o(n,{"playground-ignore":""},{default:d(()=>[C]),_:1})]),T,e("div",w,[e("h3",k,[o(l,{to:"#Configurationfile"},{default:d(()=>[t("#")]),_:1}),t("Configuration file")]),S]),e("div",V,[e("h3",D,[o(l,{to:"#Custompages"},{default:d(()=>[t("#")]),_:1}),t("Custom pages")]),N,o(n,{"playground-ignore":""},{default:d(()=>[E]),_:1}),R,o(n,{"playground-ignore":""},{default:d(()=>[z]),_:1})]),e("div",M,[e("h3",B,[o(l,{to:"#Commandrelated"},{default:d(()=>[t("#")]),_:1}),t("Command related")]),L,o(n,{"playground-ignore":""},{default:d(()=>[A]),_:1}),P,o(n,{"playground-ignore":""},{default:d(()=>[I]),_:1}),O,o(n,{"playground-ignore":""},{default:d(()=>[Q]),_:1}),G,o(n,{"playground-ignore":""},{default:d(()=>[U]),_:1}),q,o(n,{"playground-ignore":""},{default:d(()=>[F]),_:1}),$,o(n,{"playground-ignore":""},{default:d(()=>[H]),_:1}),W,o(n,{"playground-ignore":""},{default:d(()=>[K]),_:1}),Y,o(n,{"playground-ignore":""},{default:d(()=>[J]),_:1}),X,o(n,{"playground-ignore":""},{default:d(()=>[Z]),_:1}),ee,o(n,{"playground-ignore":""},{default:d(()=>[te]),_:1}),oe,o(n,{"playground-ignore":""},{default:d(()=>[de]),_:1}),ne,o(n,{"playground-ignore":""},{default:d(()=>[le]),_:1}),se,o(n,{"playground-ignore":""},{default:d(()=>[ce]),_:1}),re,o(n,{"playground-ignore":""},{default:d(()=>[ie]),_:1}),ae,o(n,{"playground-ignore":""},{default:d(()=>[he]),_:1}),ue,o(n,{"playground-ignore":""},{default:d(()=>[pe]),_:1}),me,o(n,{"playground-ignore":""},{default:d(()=>[ge]),_:1}),_e,o(n,{"playground-ignore":""},{default:d(()=>[fe]),_:1}),ve,o(n,{"playground-ignore":""},{default:d(()=>[be]),_:1})]),e("div",ye,[e("h3",je,[o(l,{to:"#Notebeforepublish"},{default:d(()=>[t("#")]),_:1}),t("Note before publish")]),xe]),e("div",Ce,[e("h3",Te,[o(l,{to:"#Q&A"},{default:d(()=>[t("#")]),_:1}),t("Q & A")]),we,ke,o(n,null,{default:d(()=>[Se]),_:1})])])}const Le=r(h,[["render",Ve]]);export{Le as default};
