...
`),s("span",{class:"hljs-tag"},[t("</"),s("span",{class:"hljs-name"},"template"),t(">")]),t(`
`)])],-1);function z(B,k,x,C,I,U){const o=l("router-link"),n=l("var-site-code-example");return i(),p("div",h,[d,s("div",m,[s("h3",u,[a(o,{to:"#Intro"},{default:e(()=>[t("#")]),_:1}),t("Intro")]),_]),s("div",j,[s("h3",f,[a(o,{to:"#BasicUsage"},{default:e(()=>[t("#")]),_:1}),t("Basic Usage")]),g,a(n,{"playground-ignore":""},{default:e(()=>[v]),_:1}),b,a(n,{"playground-ignore":""},{default:e(()=>[y]),_:1}),a(n,{"playground-ignore":""},{default:e(()=>[w]),_:1})])])}const A=c(r,[["render",z]]);export{A as default};
