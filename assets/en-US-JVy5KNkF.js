...
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"style"),s(">")]),s(`
`)])],-1),w=a("h2",null,"API",-1),V={class:"card"},D={id:"Options"},B=r("<table><thead><tr><th>Option</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>color</code></td><td>Ripple color</td><td><em>string</em></td><td><code>currentColor</code></td></tr><tr><td><code>disabled</code></td><td>Whether to disable ripple</td><td><em>boolean</em></td><td><code>false</code></td></tr></tbody></table>",1),U={class:"card"},$={id:"StyleVariables"},I=r('<p>Here are the CSS variables used by the component. Styles can be customized using <a href="#/en-US/style-provider">StyleProvider</a>.</p><table><thead><tr><th>Variable</th><th>Default</th></tr></thead><tbody><tr><td><code>--ripple-cubic-bezier</code></td><td><code>cubic-bezier(0.68, 0.01, 0.62, 0.6)</code></td></tr><tr><td><code>--ripple-color</code></td><td><code>currentColor</code></td></tr></tbody></table>',2);function N(O,z,P,R,T,W){const e=c("router-link"),n=c("var-site-code-example");return i(),p("div",d,[u,a("div",j,[a("h3",b,[t(e,{to:"#Intro"},{default:l(()=>[s("#")]),_:1}),s("Intro")]),_]),a("div",m,[a("h3",g,[t(e,{to:"#BasicUsage"},{default:l(()=>[s("#")]),_:1}),s("Basic Usage")]),t(n,null,{default:l(()=>[v]),_:1})]),a("div",f,[a("h3",y,[t(e,{to:"#CustomColor"},{default:l(()=>[s("#")]),_:1}),s("Custom Color")]),t(n,null,{default:l(()=>[k]),_:1})]),a("div",x,[a("h3",S,[t(e,{to:"#DisabledStatus"},{default:l(()=>[s("#")]),_:1}),s("Disabled Status")]),t(n,null,{default:l(()=>[C]),_:1})]),w,a("div",V,[a("h3",D,[t(e,{to:"#Options"},{default:l(()=>[s("#")]),_:1}),s("Options")]),B]),a("div",U,[a("h3",$,[t(e,{to:"#StyleVariables"},{default:l(()=>[s("#")]),_:1}),s("Style Variables")]),I])])}const A=o(h,[["render",N]]);export{A as default};
