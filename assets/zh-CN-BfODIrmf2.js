import{G as e,L as t,N as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-DxIRHDbJ.js";import{t as c}from"./_plugin-vue_export-helper-BDNMzG2s.js";var l={components:{}},u={class:`varlet-site-doc`},d={class:`card`},f={id:`jie4shao4`},p={class:`card`},m={id:`zu3jian4shi4diao4yong4`},h={class:`card`},g={id:`han2shu4shi4diao4yong4`},_={class:`card`},v={id:`shu3xing4`},y={class:`card`},b={id:`cha1cao2`};function x(c,l,x,S,C,w){let T=t(`router-link`),E=t(`var-site-code-example`);return n(),i(`div`,u,[l[16]||=r(`h1`,null,`样式定制`,-1),r(`div`,d,[r(`h3`,f,[a(T,{to:`#jie4shao4`},{default:e(()=>[...l[0]||=[o(`#`,-1)]]),_:1}),l[1]||=o(`介绍`,-1)]),l[2]||=r(`p`,null,[o(`通过 StyleProvider 组件可以很容易的挂载样式变量，组件提供了 `),r(`code`,null,`组件式调用`),o(` 和 `),r(`code`,null,`函数式调用`),o(` 两种调用方式。`)],-1)]),r(`div`,p,[r(`h3`,m,[a(T,{to:`#zu3jian4shi4diao4yong4`},{default:e(()=>[...l[3]||=[o(`#`,-1)]]),_:1}),l[4]||=o(`组件式调用`,-1)]),l[6]||=r(`p`,null,[o(`局部的定制组件样式，需要注意的是使用 `),r(`code`,null,`teleport`),o(` 传送到 `),r(`code`,null,`StyleProvider`),o(` 外的元素将不会生效。`)],-1),a(E,null,{default:e(()=>[...l[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
