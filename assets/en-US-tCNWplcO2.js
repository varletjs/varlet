import{G as e,L as t,N as n,c as r,d as i,g as a,h as o,m as s}from"./runtime-core.esm-bundler-5xw830oL.js";import{t as c}from"./_plugin-vue_export-helper-V-yks4gF.js";var l={components:{}},u={class:`varlet-site-doc`},d={class:`card`},f={id:`Intro`},p={class:`card`},m={id:`BasicUsage`},h={class:`card`},g={id:`Combine`},_={class:`card`},v={id:`Attention`},y={class:`card`},b={id:`Props`},x={class:`card`},S={id:`Events`},C={class:`card`},w={id:`Slots`},T={class:`card`},E={id:`StyleVariables`};function D(c,l,D,O,k,A){let j=t(`router-link`),M=t(`var-site-code-example`);return n(),i(`div`,u,[l[27]||=r(`h1`,null,`PullRefresh`,-1),r(`div`,d,[r(`h3`,f,[a(j,{to:`#Intro`},{default:e(()=>[...l[0]||=[o(`#`,-1)]]),_:1}),l[1]||=o(`Intro`,-1)]),l[2]||=r(`p`,null,`Provides a drop-down refresh interaction.`,-1)]),r(`div`,p,[r(`h3`,m,[a(j,{to:`#BasicUsage`},{default:e(()=>[...l[3]||=[o(`#`,-1)]]),_:1}),l[4]||=o(`Basic Usage`,-1)]),l[6]||=r(`p`,null,[o(`The refresh event will be Emitted when pull refresh, you should set `),r(`code`,null,`v-model`),o(` to `),r(`code`,null,`true`),o(` at the beginning of the event indicates that loading is under way, and setting `),r(`code`,null,`v-model`),o(` to `),r(`code`,null,`false`),o(` after completion indicates that loading is over.`)],-1),a(M,null,{default:e(()=>[...l[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,h,[r(`h3`,g,[a(j,{to:`#Combine`},{default:e(()=>[...l[7]||=[o(`#`,-1)]]),_:1}),l[8]||=o(`Combine`,-1)]),l[10]||=r(`p`,null,[o(`Combined with the `),r(`code`,null,`List`),o(` component to implement the function of pull-up loading and pull-down refresh, ensuring the height of the `),r(`code`,null,`PullRefresh`),o(` is not `),r(`code`,null,`0`),o(` .`)],-1),a(M,null,{default:e(()=>[...l[9]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
`),r(`span`,{class:`hljs-keyword`},`import`),o(` { ref } `),r(`span`,{class:`hljs-keyword`},`from`),o(),r(`span`,{class:`hljs-string`},`'vue'`),o(`
...
`),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  ...
  `),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-pull-refresh`),o(`>`)]),o(`
`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,_,[r(`h3`,v,[a(j,{to:`#Attention`},{default:e(()=>[...l[11]||=[o(`#`,-1)]]),_:1}),l[12]||=o(`Attention`,-1)]),l[14]||=r(`p`,null,[o(`When the height of the `),r(`code`,null,`PullRefresh`),o(` is `),r(`code`,null,`0`),o(`, it will be unavailable, so you need to ensure that the height of its child elements is `),r(`strong`,null,`not`),o(),r(`code`,null,`0`),o(` or set height for the `),r(`code`,null,`PullRefresh`),o(`:`)],-1),a(M,{"playground-ignore":``},{default:e(()=>[...l[13]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
  `),r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-pull-refresh`),o(`>`)]),o(`
