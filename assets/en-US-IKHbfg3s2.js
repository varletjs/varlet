import{G as e,L as t,N as n,c as r,d as i,g as a,h as o}from"./runtime-core.esm-bundler-5xw830oL.js";import{t as s}from"./_plugin-vue_export-helper-V-yks4gF.js";var c={components:{}},l={class:`varlet-site-doc`},u={class:`card`},d={id:`Intro`},f={class:`card`},p={id:`StyleBinding`},m={class:`card`},h={id:`FunctionBinding`},g={class:`card`},_={id:`SelectivelyEnableForDifferentDevices`};function v(s,c,v,y,b,x){let S=t(`router-link`),C=t(`var-site-code-example`);return n(),i(`div`,l,[c[18]||=r(`h1`,null,`Hover`,-1),r(`div`,u,[r(`h3`,d,[a(S,{to:`#Intro`},{default:e(()=>[...c[0]||=[o(`#`,-1)]]),_:1}),c[1]||=o(`Intro`,-1)]),c[2]||=r(`p`,null,`Style binding is performed when the pointer hovers the binding element, and the current hovering state can also be obtained through a function, which supports selective enablement on desktop or mobile.`,-1)]),r(`div`,f,[r(`h3`,p,[a(S,{to:`#StyleBinding`},{default:e(()=>[...c[3]||=[o(`#`,-1)]]),_:1}),c[4]||=o(`Style Binding`,-1)]),c[6]||=r(`p`,null,`The style binding is performed when the pointer hovers over the bound element, and the style binding is canceled when the pointer leaves the element.`,-1),a(C,null,{default:e(()=>[...c[5]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`template`),o(`>`)]),o(`
...
`)])],-1)]]),_:1})]),r(`div`,m,[r(`h3`,h,[a(S,{to:`#FunctionBinding`},{default:e(()=>[...c[7]||=[o(`#`,-1)]]),_:1}),c[8]||=o(`Function Binding`,-1)]),c[10]||=r(`p`,null,`The function is triggered when the pointer hovers and leaves, and carries the current hover state.`,-1),a(C,null,{default:e(()=>[...c[9]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`script`),o(),r(`span`,{class:`hljs-attr`},`setup`),o(`>`)]),r(`span`,{class:`javascript`},[o(`
...
`)]),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`style`),o(`>`)]),o(`
`)])],-1)]]),_:1})]),r(`div`,g,[r(`h3`,_,[a(S,{to:`#SelectivelyEnableForDifferentDevices`},{default:e(()=>[...c[11]||=[o(`#`,-1)]]),_:1}),c[12]||=o(`Selectively Enable For Different Devices`,-1)]),c[15]||=r(`p`,null,[o(`Considering the differences in `),r(`code`,null,`hover`),o(` effects on different platforms, the hover command can only be enabled on specific platforms.`)],-1),c[16]||=r(`h4`,null,`Only Enabled On Desktop`,-1),a(C,{"playground-ignore":``},{default:e(()=>[...c[13]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-paper`),o(),r(`span`,{class:`hljs-attr`},`v-hover:desktop`),o(`=`),r(`span`,{class:`hljs-string`},`"{ color: '#fff' }"`),o(`">`)]),o(`HOVER`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-paper`),o(`>`)]),o(`
`)])],-1)]]),_:1}),c[17]||=r(`h4`,null,`Only Enabled On Mobile`,-1),a(C,{"playground-ignore":``},{default:e(()=>[...c[14]||=[r(`pre`,{class:`hljs`},[r(`code`,null,[r(`span`,{class:`hljs-tag`},[o(`<`),r(`span`,{class:`hljs-name`},`var-paper`),o(),r(`span`,{class:`hljs-attr`},`v-hover:mobile`),o(`=`),r(`span`,{class:`hljs-string`},`"{ color: '#fff' }"`),o(`">`)]),o(`HOVER`),r(`span`,{class:`hljs-tag`},[o(`</`),r(`span`,{class:`hljs-name`},`var-paper`),o(`>`)]),o(`
