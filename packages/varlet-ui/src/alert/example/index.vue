...
<template>
  ...
  <var-space :size="[10, 10]">
    ...
    <var-alert :title="t('alertTitle')" :text="t('alertText')" type="warning" style="margin-top: 10px" />
  ...
  <var-space :size="[10, 10]">
    <var-alert :title="t('alertTitle')" :text="t('alertText')" :type="type" />
    <var-alert
      :title="t('alertTitle')"
      :text="t('alertText')"
      variant="outlined"
    ...
    />
    <var-alert :title="t('alertTitle')" :text="t('alertText')" variant="tonal" :type="type" style="margin-top: 10px" />
  </var-space>
  ...
  <var-alert v-if="show" :title="t('alertTitle')" :text="t('alertText')" closeable @click="show = false">
    <template #icon>
      <var-icon name="heart" />
    </template>
  </var-alert>
