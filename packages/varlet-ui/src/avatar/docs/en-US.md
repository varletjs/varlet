...
<template>
  <var-avatar-group>
    <var-tooltip placement="top" content="varlet">
      <var-avatar src="https://varlet.gitee.io/varlet-ui/varlet_icon.png" bordered />
    </var-tooltip>
    <var-tooltip placement="top" content="haoziqaq">
    ...
    <template #rest>
      <var-menu trigger="hover" placement="top">
        ...
        <template #menu>
          <var-cell>vue</var-cell>
          <var-cell>vite</var-cell>
        </template>
      </var-menu>
    </template>
  </var-avatar-group>
