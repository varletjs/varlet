...
<template>
  ...
  <var-space direction="column" :size="['3vmin', '4vmin']">
    ...
    <var-button type="primary" block @click="modifyTitle">
      {{ pack.modifyTitle }}
    </var-button>
    <var-button type="primary" block @click="disableAction">
      {{ pack.disabled }}
    </var-button>
    <var-button type="primary" block @click="disableCloseOnClickAction">
      {{ pack.disableCloseOnClickAction }}
    </var-button>
    <var-button type="primary" block @click="customActionStyles">
  ...
  <var-space direction="column" :size="['3vmin', '4vmin']">
    ...
    <var-button type="warning" block @click="show1 = true">
      {{ pack.modifyTitle }}
    </var-button>
    <var-button type="warning" block @click="show2 = true">
      {{ pack.disabled }}
    </var-button>
    <var-button type="warning" block @click="show3 = true">
      {{ pack.disableCloseOnClickAction }}
    </var-button>
    <var-button type="warning" block @click="show4 = true">
      {{ pack.customActionStyles }}
    </var-button>
  </var-space>
