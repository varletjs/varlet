...
```html
<template>
  <img class="lazy-example-cat" v-lazy="'https://varlet.pages.dev/cat.jpg'">
</template>
...
<template>
  <div 
    ...
    v-lazy:background-image="'https://varlet.pages.dev/cat.jpg'"
  ></div>
</template>
...
<template>
  <img
    class="lazy-example-cat"
    v-lazy="'https://varlet.pages.dev/cat.jpg'"
